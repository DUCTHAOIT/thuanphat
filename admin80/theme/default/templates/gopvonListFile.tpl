...
<table width="100%" border="1" cellspacing="0" cellpadding="0" class="table">
  ...
  <tr>
	...
	<label style="padding-right:5px" title="Edit"><a href="?m=gopvon&op=file&id={$item.proid}&idFile={$key}"><img src="images/edit.gif" style="cursor:pointer" border="0" /></a> </label>
