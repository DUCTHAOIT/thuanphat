...
<form name="frmmain" action="?m=topup" method="post" enctype="multipart/form-data">
<input type="hidden" name="op" value="addtopup" />
  ...
  <tr>
    <td nowrap="nowrap" style="padding-right:10px">
      ...
      <!--
	    ...
	    <td><input name="topup_in" type="text" style="width:80%" class="text" maxlength="255" value="{$arr.topup_in}" /></td>
	    </tr>
       <tr>
	  ...
	  <tr>
	    ...
	    <td><input name="topup_in" type="text" style="width:80%" class="text" maxlength="255" value="{$arr.topup_in}" />(http://www.linkwebsite.com)</td>
	    </tr>
	  <tr>
	 ...
	 <tr>
	  ...
	  <tr>
	    <td align="right" style="padding-right:10px" nowrap="nowrap">{$topups_sold_in}:</td>
	    <td><input name="topup_in" type="text" style="width:80%" class="text" maxlength="255" value="{$arr.topup_in}" /></td>
	    </tr>
...
<script language="Javascript1.2">
	...
	function manufacturers(){		
		AjaxRequest.get(
			{
			'url':'?m=topup&f=search_manufacturers&fid='+document.frmmain.catID.value + '&id_topup=' + document.frmmain.id.value
	...
	function xuatsu(){		
		AjaxRequest.get(
			{
			'url':'?m=topup&f=search_xuatsu&fid='+document.frmmain.catID.value + '&id_topup=' + document.frmmain.id.value
	...
	function technical(){		
		AjaxRequest.get(
			{
			'url':'?m=topup&f=search_criteria&fid='+document.frmmain.catID.value + '&id_topup=' + document.frmmain.id.value
	...
	function logo_hang_san_xuat(){		
		AjaxRequest.get(
			{
			'url':'?m=topup&f=logo_hang_san_xuat&id_hang_san_xuat='+document.frmmain.hang_san_xuat.value
