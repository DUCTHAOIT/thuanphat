...
<table border="1" cellspacing="0" cellpadding="0" class="table" width="100%">
 ...
 {if $arr[i].sort==1}
  <tr bgcolor="{cycle values="#ffffff,#F4F4F4"}">
    ...
    <td align="center" class="td" nowrap="nowrap"><a href="?m=user&f=xuatsu2&id={$arr[i].id}"><img src="images/edit.gif" border="0" /></a> &nbsp; <a href="?m=user&f=xuatsu2&op=del&id={$arr[i].id}"><img src="images/delete.gif" border="0" /></a></td>
    </tr>
   {else}
    <tr bgcolor="{cycle values="#ffffff,#F4F4F4"}">
