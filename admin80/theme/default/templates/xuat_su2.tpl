...
<script type="text/javascript" src="js/jscalendar/calendar-setup.js"></script>
	<script language="javascript">
		...
		function searchList(str)
		{
			AjaxRequest.get(
			{
			'url':'?m=tstt&f=xuatsu&op=search&search='+ str
...
{/literal}
<div style="text-transform:uppercase" class="title">ĐẦU TƯ TĂNG TRƯỞNG TSTT</div>
<form name="frmmain" action="?m=tstt&f=xuatsu" method="post" enctype="multipart/form-data">
