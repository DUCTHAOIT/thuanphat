...
<form name="frmmain" action="?m=userorder" method="post" enctype="multipart/form-data">
<input type="hidden" name="op" value="adduserorder" />
  ...
  <tr>
    <td nowrap="nowrap" style="padding-right:10px">
      ...
      <!--
	    ...
	    <td><input name="userorder_in" type="text" style="width:80%" class="text" maxlength="255" value="{$arr.userorder_in}" /></td>
	    </tr>
       <tr>
	  ...
	  <tr>
	    ...
	    <td><input name="userorder_in" type="text" style="width:80%" class="text" maxlength="255" value="{$arr.userorder_in}" />(http://www.linkwebsite.com)</td>
	    </tr>
	  <tr>
	 ...
	 <tr>
	  ...
	  <tr>
	    <td align="right" style="padding-right:10px" nowrap="nowrap">{$userorders_sold_in}:</td>
	    <td><input name="userorder_in" type="text" style="width:80%" class="text" maxlength="255" value="{$arr.userorder_in}" /></td>
	    </tr>
...
<script language="Javascript1.2">
	...
	function manufacturers(){		
		AjaxRequest.get(
			{
			'url':'?m=userorder&f=search_manufacturers&fid='+document.frmmain.catID.value + '&id_userorder=' + document.frmmain.id.value
	...
	function xuatsu(){		
		AjaxRequest.get(
			{
			'url':'?m=userorder&f=search_xuatsu&fid='+document.frmmain.catID.value + '&id_userorder=' + document.frmmain.id.value
	...
	function technical(){		
		AjaxRequest.get(
			{
			'url':'?m=userorder&f=search_criteria&fid='+document.frmmain.catID.value + '&id_userorder=' + document.frmmain.id.value
	...
	function logo_hang_san_xuat(){		
		AjaxRequest.get(
			{
			'url':'?m=userorder&f=logo_hang_san_xuat&id_hang_san_xuat='+document.frmmain.hang_san_xuat.value
