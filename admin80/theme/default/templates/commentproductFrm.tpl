{literal}{/literal}
<form name="frmmain" action="?m=commentproduct" method="post" enctype="multipart/form-data">
<input type="hidden" name="op" value="update" />
<input type="hidden" name="id" value="{$id}" />
<input type="hidden" name="fileName" value="{$arr.img}" />
<div class="topic">{$commentproduct_infomation}</div>
<table width="60%" border="1" cellspacing="0" cellpadding="0" class="table">
  ...
  <tr>
    <td nowrap="nowrap" class="td">Ý kiến</td>
