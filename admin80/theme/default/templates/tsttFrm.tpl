...
<form name="frmmain" action="?m=tstt" method="post" enctype="multipart/form-data">
<input type="hidden" name="op" value="addtstt" />
  ...
  <tr>
    <td nowrap="nowrap" style="padding-right:10px">
      ...
      <!--
	    ...
	    <td><input name="tstt_in" type="text" style="width:80%" class="text" maxlength="255" value="{$arr.tstt_in}" /></td>
	    </tr>
       <tr>
	  ...
	  <tr>
	    ...
	    <td><input name="tstt_in" type="text" style="width:80%" class="text" maxlength="255" value="{$arr.tstt_in}" />(http://www.linkwebsite.com)</td>
	    </tr>
	  <tr>
	 ...
	 <tr>
	  ...
	  <tr>
	    <td align="right" style="padding-right:10px" nowrap="nowrap">{$tstts_sold_in}:</td>
	    <td><input name="tstt_in" type="text" style="width:80%" class="text" maxlength="255" value="{$arr.tstt_in}" /></td>
	    </tr>
...
<script language="Javascript1.2">
	...
	function checkInput(){
		...
		if(!obj.name.value){
			alert("Bạn cần nhập Số Hợp Đồng!");
			obj.name.focus();
			return;
		}
		if(!obj.price_old.value){
			alert("Bạn cần nhập Giá trị mua!");
			obj.price_old.focus();
			return;
		}
		if(!obj.price_new.value){
			alert("Bạn cần nhập Giá mua 1 ĐVĐT bình quân!");
			obj.price_new.focus();
			return;
		}
		if(!obj.model.value){
		alert("Bạn cần nhập Số lượng ĐVĐT!");
		obj.model.focus();
			return;
		}	
		else{		
