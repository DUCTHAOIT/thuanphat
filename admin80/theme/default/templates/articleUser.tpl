{literal}
	<script language="javascript" type="text/javascript">
		...
		{			
			...
			f
			,{
			  'url':'?m=article&op=mainShowUser'
			  ,'onSuccess':function(req){ document.getElementById('listArticleUser').innerHTML=req.responseText;}
			  ,'onError':function(req){}
			}
		  );
		  progress('listArticleUser');
		  return status;		
		}	
		function goEdit(id){
...
<input type="hidden" name="op" value="listUser" />
...
<div id="listArticleUser">{listArticleUser}</div>