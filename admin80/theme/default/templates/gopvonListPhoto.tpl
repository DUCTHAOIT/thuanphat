...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="border:1px solid #cccccc">
  <tr>
	...
	{if $item.img}<a href="?m=gopvon&op=photo&id={$item.proid}&idPhoto={$key}"><img src="{$smarty.const._DOMAIN_ROOT_URL}/images/gopvon/{$item.img}" border="0" onmouseover="border='1'" onmouseout="border='0'" width="120" /></a>{/if}</div>	
