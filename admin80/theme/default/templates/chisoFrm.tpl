<form name="frmmain" action="?m=chiso" method="post" enctype="multipart/form-data">
...
<script type="text/javascript" src="js/jscalendar/calendar-setup.js"></script>
  ...
  <tr>
    <td align="right" style="padding-right:10px" nowrap="nowrap">TSTT (%):</td>
    <td colspan="2" class="td"><input type="text" name="giatri1" class="text" value="{$arr.giatri1}" /></td>
  </tr>
  <tr>
    <td align="right" style="padding-right:10px" nowrap="nowrap">TSBV (%):</td>
   
    <td class="td"><input type="text" name="giatri2" class="text" value="{$arr.giatri2}" /></td>
  </tr>
  <tr>
 ...
 <!-- 
  ...
  <tr>
	...
	<table border="0" cellspacing="0" cellpadding="0">
		  <tr>
			<td id="fileNamev" style="padding-bottom:10px; padding-top:10px">{if $arr.img}<img src="{$smarty.const._DOMAIN_ROOT_URL}/images/chiso/{$arr.img}" />{/if}</td>
