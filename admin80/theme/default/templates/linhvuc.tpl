{literal}
	<script language="javascript">
		...
		function searchList(str)
		{
			AjaxRequest.get(
			{
			'url':'?m=product&f=linhvuc&op=search&search='+ str
			,'onSuccess':function(req){document.getElementById('td_linhvucList').innerHTML=req.responseText;}
...
<form name="frmmain" action="?m=product&f=linhvuc" method="post" enctype="multipart/form-data">
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td valign="top" style="padding-left:10px" id="td_linhvucList">{linhvucList}</td>
  </tr>
</table>
</form>