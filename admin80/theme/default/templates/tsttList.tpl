...
<table width="100%%" border="1" cellspacing="0" cellpadding="0" class="table">
  ...
  <tr bgcolor="{cycle values="#ffffff,#F4F4F4"}">
   <td align="left" class="td">{$item.id}</td>
    ...
    <td align="right" class="td">{format_number number=$item.price_old}</td>
    <td align="right" class="td">{format_number number=$item.price}</td>
    <td align="right" class="td">{format_number number=$item.model}</td>
