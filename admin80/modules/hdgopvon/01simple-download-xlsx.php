...
$objPHPExcel->setActiveSheetIndex(0)
            ...
            ->setCellValue('L1', 'Lãi/Lỗ')
			->setCellValue('M1', 'Phí hợp tác đầu tư')
			->setCellValue('N1', 'Chi phí rút trước hạn')
			->setCellValue('O1', 'Hoa hồng CK')
			->setCellValue('P1', 'Thuế thu nhập cá nhân')
			->setCellValue('Q1', 'Thực nhận')
			->setCellValue('R1', 'Người giới thiệu')
			->setCellValue('S1', 'Hoa hồng giới thiệu')
			->setCellValue('T1', 'Thuế hoa hồng giới thiệu')
			->setCellValue('U1', 'Người GT Thực nhận')
			->setCellValue('V1', 'Trạng thái');
...
$objPHPExcel->setActiveSheetIndex(0)
            ...
            ->setCellValue('K'.$j.'', ''.number_format($tongban, 0, '.', ',').'')            
            ->setCellValue('L'.$j.'', ''.number_format($lailo, 0, '.', ',').'')
			->setCellValue('M'.$j.'', ''.number_format($phihoptac, 0, '.', ',').'')
			->setCellValue('N'.$j.'', ''.number_format($phiruttruochan, 0, '.', ',').'')
			->setCellValue('O'.$j.'', ''.number_format($hoahongck, 0, '.', ',').'')
			->setCellValue('P'.$j.'', ''.number_format($tncn, 0, '.', ',').'')
			->setCellValue('Q'.$j.'', ''.number_format($thucnhan, 0, '.', ',').'')
			->setCellValue('R'.$j.'', ''.$rs->fields("gioithieu").'')
			->setCellValue('S'.$j.'', ''.number_format($hoahongck, 0, '.', ',').'')
			->setCellValue('T'.$j.'', ''.number_format($hoahongck*0.1, 0, '.', ',').'')
			->setCellValue('U'.$j.'', ''.number_format($hoahongck*0.9, 0, '.', ',').'')
			->setCellValue('V'.$j.'', ''.$trangthai.'');
			///////
...
// Rename worksheet
$objPHPExcel->getActiveSheet()->setTitle('Hợp đồng bán TSTT');
