...
if (isset($_GET['export']) && $_GET['export'] == '1') {
    ...
    $data = [];
    $data[] = ['Thời gian yêu cầu', 'Thời gian duyệt', 'Người dùng', 'Email', 'SĐT', 'Số tiền', 'Chủ TK', 'Số TK', 'Ngân hàng', 'Lời nhắn'];
    ...
    $xlsx->downloadAs('yeu_cau_rut_tien_da_duyet.xlsx');
    exit;
}
...
<div class="container py-4">
    <h3 class="mb-4">Yêu cầu rút tiền đã duyệt</h3>
    <form method="get" class="mb-3">
        <input type="hidden" name="m" value="withdraw">
        <input type="hidden" name="f" value="approve">
        <div style="display:flex; gap:10px; align-items:center;">
            ...
            <a href="?m=withdraw&f=approve&export=1&start_date=<?= urlencode($start_date) ?>&end_date=<?= urlencode($end_date) ?>" class="btn btn-success">Xuất Excel</a>
        </div>
    </form>
