...
<form name="poll" method="post" action="/?m=poll&f=poll_update">   
    ...
    <td colspan="3" class="content">
     	<table width="100%" border="0" cellspacing="0" cellpadding="0">
		  <tr>
			...
			<td class="titleBlock" width="100%" align="left" nowrap="nowrap" style="background-image:url(<?php echo _DOMAIN_ROOT_URL?>/theme_images/block/titlebb.gif); background-repeat:repeat-x; padding-left:10px" valign="top">Bình chọn</td>
		  </tr>
		</table>
	 </td>
    </tr>  
  ...
  <?php
	...
	?>
  <tr>
    <td colspan="3" style="padding-top:5; padding-right:5; padding-bottom:5; " align="right">
	<input type="button" class="button2" onclick="checkpoll()" value="<?php echo "Đánh giá";?>" />
	<input class="button2" type="button" value="<?php echo "Kết quả";?>" onclick="timeWin()" />	</td>
  </tr>  
  </form>
</table>
<br>
