...
if (isset($_GET['export']) && $_GET['export'] == 1) {
    ...
    $xlsx->downloadAs('donhang_tuchoi.xlsx');
    exit;
}
...
<div class="container py-4">
    <h3 class="mb-4">Đơn hàng đã bị từ chối</h3>
        ...
        <div class="form-row">
            <table>
                <tr>
                    ...
                    <td>
                        <a href="?m=order&f=rejected&export=1&search=<?= urlencode($search) ?>&start_date=<?= urlencode($start_date) ?>&end_date=<?= urlencode($end_date) ?>"
