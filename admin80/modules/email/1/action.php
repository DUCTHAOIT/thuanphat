<?php
	...
	function sendNewsletter(){
		...
		foreach($chkdelete as $key=>$value){
			...
			if(SendMail2($emailFrom,$nameFrom, $to,$to, $subject, $TEXT,$HTML."<br>Bạn từ chối nhận mail click link:"._DOMAIN_ROOT_URL."/?m=newsletter&f=confirmoff&ID=".$ID."&key=".$rand_key."",$ATTM))
			{
