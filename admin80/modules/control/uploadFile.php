...
?>
	...
	function _return(){
		text = '<img style="max-width:500" src=<?php echo _DOMAIN_ROOT_URL?>/temp/' + fileName + '>';
	...
	<form name="frmUpload" action="?m=control&f=uploadFile" target="hframe" method="post" enctype="multipart/form-data">
