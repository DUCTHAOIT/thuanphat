...
?>
	...
	function _return(){
		text = '<img src=<?php echo _DOMAIN_ROOT_URL?>/admin80/images/_' + fileType + '.gif>';
		opener.document.frmmain.<?php echo getParam("fileName")?>.value= fileName;
		opener.document.getElementById('<?php echo getParam("fileName")?>v').innerHTML = text;
		window.close();
	}
	</script>
