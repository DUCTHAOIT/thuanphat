...
?>
	...
	function _return(){
		text = '<img  style="max-width:500px" src=<?php echo _DOMAIN_ROOT_URL?>/modules/photo/newgallery/thumbs/' + fileName + '>';
	...
	<form name="frmUpload" action="?m=control&f=uploadFilePhoto" target="hframe" method="post" enctype="multipart/form-data">
...
<?php
	...
	function callUploadFile(){
		...
		for($i=0;$i<count($tem);$i++){
			...
			$path= _DOMAIN_ROOT_PATH."/modules/photo/newgallery/thumbs/";
			//$name = uniquename().$ext;
