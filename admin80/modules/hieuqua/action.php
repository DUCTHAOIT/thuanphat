<?php
	...
	function updatehieuqua(){
		...
		if(!$id){
			...
			$sql = "INSERT INTO sys_hieuqua ( giatri1, giatri2, giatri3, nam, thang, ngay, namvni, thangvni, ngayvni, date_create, lang, tangtruong1, tangtruong2 ) VALUES ( '$giatri1', '$giatri2', '$giatri3', '$nam', '$thang', '$ngay', '$namvni', '$ngayvni', '$thangvni', '$date_create', '$lang', '$tangtruong1', '$tangtruong2')";				
			...
			$sql= "UPDATE sys_hieuqua SET giatri1 = '$giatri1', giatri2 = '$giatri2', giatri3 = '$giatri3', nam = '$nam', thang = '$thang', ngay = '$ngay', namvni = '$namvni', thangvni = '$thangvni', ngayvni = '$ngayvni', date_create = '$date_create' WHERE id=$id";
			$return=$db->Execute($sql);
			//neu edit thanh cong tin=> cap nhat nhom tin  vao bang sys_hieuqua_cat
		}		
		include(_DOMAIN_ROOT_PATH . "/classes/msgbox.class.php");		
		if(!$return){
			$ret_page="?m=hieuqua&op=frm";
	...
	function arrList(){		
		global $db,$lang;		
		$sql="SELECT sys_hieuqua.*, DATE_FORMAT(sys_hieuqua.date_create, '".format_date()."') as date_create FROM sys_hieuqua WHERE (lang='$lang') AND (loai=0) ORDER BY sys_hieuqua.date_create DESC";
