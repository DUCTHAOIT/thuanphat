<?php
	...
	function mainShow(){
		...
		$smarty->display(_DOMAIN_ROOT_TEMPLATE.'/hieuqua.tpl','hieuqua_'.$themeName);		
	...
	function listhieuqua(){		
		...
		$smarty->display(_DOMAIN_ROOT_TEMPLATE.'/hieuquaList.tpl','hieuquaList_'.$themeName);		
	}
	//
	function frmAddhieuqua(){
		...
		$smarty->display(_DOMAIN_ROOT_TEMPLATE.'/hieuquaFrm.tpl','hieuquaFrm_'.$themeName);
