<html>
    ...
    <body>
        <p align="center"><strong>0.iCỘNG HÒA XÃ HỘI  CHỦ NGHĨA VIỆT NAM</strong><br>
...
<p>  
  ...
  Họ tên:                                  <br>
  Sinh năm: <br>
  Số CMND/căn cước công dân: <br>
  Cấp ngày:                                    Nơi cấp: <br>
  Địa chỉ: <br>
  Email: <br>
  Số tài khoản ngân hàng bên A: <br>
  Chủ tài khoản: <br>
  Ngân hàng: <br>
...
<table border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="467" valign="top"><br>
        <strong>Đại diện bên A</strong> </td>
    <td width="467" valign="top"><p align="center"><strong>Đại diện bên B</strong></p></td>
  </tr>
</table>
