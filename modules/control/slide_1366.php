<?php 
    ...
    <script>
        ...
        height: 354px;" align="center">
       
        <!-- Slides Container -->
        <div u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; width:1366px; height: 354px;
            overflow: hidden;">
            <?php
				foreach($arr as $k=>$v){
				?>
					<div><img  u="image" src="<?php echo _DOMAIN_ROOT_URL;?>/img/logo/<?php echo $v["logo"];?>" border="0" style="cursor:pointer"  onclick="imageClick('<?php echo $v["link"];?>')" /></div>
				<?php
				}
				?> 
        </div>        
        ...
        <style>
         ...
         <!-- Arrow Left -->
        <span u="arrowleft" class="jssora05l" style="width: 40px; height: 40px; top: 130px; left: 200px;">
        </span>
        <!-- Arrow Right -->
        <span u="arrowright" class="jssora05r" style="width: 40px; height: 40px; top: 130px; right: 200px">
        </span>
