<?php
	function products_most_viewed()
	{
		...
		$sql.=" WHERE (sys_product.catID =  sys_function.id) AND (sys_product.hang_san_xuat =  hang_san_xuat.id) AND (sys_product.ctrl&1=1) AND (sys_product.access > 1) AND (sys_product.special_promotion=0)";
