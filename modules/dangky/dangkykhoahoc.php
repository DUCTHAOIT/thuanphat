...
<div class="title col-xs-12 col-sm-12 col-md-12" style="padding-bottom:10px;"><?php echo $rs->fields("name");?></div>
        ...
        <div class="col-xs-12 col-sm-6 col-md-6">
                ...
                <input type="hidden" name="loaidt" value="0" />
                ...
                <input type="hidden" name="sogio" value="<?php echo $rs->fields("promotion");?>" />
    ...
    <div class="col-xs-12 col-sm-6 col-md-6">
        <table width="100%" border="0" cellspacing="0" cellpadding="10">
          ...
          <input type="hidden" name="tong" id="inputtong" value="<?php echo $rs->fields("price".$loaiuser."");?>" />
          <?php }else{?>
           <tr>
           
            <td style="border-bottom: 0.5px solid #2fd7b3; padding-top:10px; padding-bottom:10px"  align="left"><input  name="voucher"  style="width:100%;" placeholder="Nhập Voucher" class="text" id="inputvoucher" />
             <td style="border-bottom: 0.5px solid #2fd7b3; padding-top:10px; padding-bottom:10px; padding-left:5px">
             <input type="button" value="Kiểm tra" id="checkvoucher" class="btn btn-primary" style="padding-left:0px; padding-right:0px;">
             </td>
            </td>
          </tr>
           <tr>
          ...
          <tr>
            <td style="padding-top:10px; padding-bottom:10px" class="title">Tổng</td>
            <td  style="padding-top:10px; padding-bottom:10px; color:#FF6600; font-size:1.1rem" class="title" align="right" id="addVoucher"><?php echo number_format($rs->fields("price"), 0, '.', ',');?>đ</td>
          </tr>
          <?php }?>
        </table>
...
function submitContactForm(){
    ...
    if(name.trim() == '' ){
        ...
        alert('Xác nhận tổng thanh toán');
        $('#inputtong').focus();
        return false;
    }else{
        $('#frmDangky').submit();	
