...
$mysqli->query("INSERT INTO commissions (order_id, user_id, level, amount)
                VALUES ($order_id, $user_id, 0, $total_amount * 0.08)");
...
$HTML .= "Họ tên: ".$name;
$HTML .= "Điện thoại: ".$mobile;
$HTML .= "Địa chỉ: ".$address;
$HTML .= "Lưu ý: ".$note;
$HTML .="<b>Thông tin đơn hàng:</b>";
$HTML .= nl2br($products_text); // Nội dung hiển thị trong email
$HTML .= "Tổng Tiền: ".$total_amount;
...
if ($mail == 1) {
    ...
    echo "<div style=\"padding:100px 20px\" align=\"center\">
