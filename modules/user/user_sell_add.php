	...
	include_once("header.php");	
		...
		$contents.='<table width="100%" border="1" cellspacing="0" cellpadding="0" class="table">
					  <tr>
						...
						<td align="left" style="padding-left:10px;" width="50%">MC-'.$rs->fields("id").'</td>
					  </tr>
					  <tr>
					   ...
					   <tr>
						...
						<td align="left" style="padding-left:10px;" width="50%">'.$rs->fields("giaidoan").'</td>
					  </tr>
					  <tr>
						<td align="right" style="padding-right:10px;" nowrap="nowrap">Số suất đầu tư: </td>
						<td align="left" style="padding-left:10px;" width="50%">'.$rs->fields("soxuatdautu").'</td>
					  </tr>
					   <tr>
						<td align="right" style="padding-right:10px;" nowrap="nowrap">Số tiền / một suất: </td>
						<td align="left" style="padding-left:10px;" width="50%">'.number_format($rs->fields("sotienmotxuat"), 0, '.', ',').'</td>
					  </tr>
					  <tr>
						<td align="right" style="padding-right:10px;" nowrap="nowrap">Chiết khấu: </td>
						<td align="left" style="padding-left:10px;" width="50%">'.number_format($rs->fields("chietkhau"), 0, '.', ',').'</td>
					  </tr>
					  <tr>
					  ...
					  <tr>
						<td colspan="2">
						<p>Quý khách hãy nhắn tin SMS tới từ số điện thoại đăng ký tài khoản tới hotline của chúng tôi với nội dung sau để xác thực yêu cầu hoàn cọc:<br><strong>Hoan coc MC-'.$rs->fields("id").'</strong> <br> Sau  1 ngày làm việc nếu yêu cầu hoàn cọc chưa được xác nhận thì sẽ tự hủy.</p>
						</td>
					  </tr>
				</table>';	
