    ...
    <div class="tabContainer">
        <ul class="tabHead">
            <li class="currentBtn" style="margin-right:2px; margin-bottom:2px"><a href="javascript:;"><i class="fa fa-calendar"></i> Giao dịch</a></li>
             <li style="margin-right:2px; margin-bottom:2px"><a href="javascript:;"><i class="fa fa-heart"></i> Tổng quan TSBV</a></li>
            ...
            <li class="tabCot" style="display: list-item;">
                <table width="100%" border="1" cellspacing="0" cellpadding="0" class="table">
                  ...
                  <tr>
                    ...
                    <td class="td" style="text-align: center; vertical-align: middle;"><strong>{if (($arrTSI.giadvdt-$arrTSITangGiam.giadvdt))>0}<strong style="color:#0000CC">{else}<strong style="color:#FF0000">{/if}{format_number2 number=($arrTSI.giadvdt-$arrTSITangGiam.giadvdt)/$arrTSITangGiam.giadvdt*100}%</strong></td>
                    
                   
                    <td align="center" style="text-align: center; vertical-align: middle; max-width:145px;" nowrap="nowrap">
                     {if $cmt}
                     	{if $timeduocmua=='1'}
                        <button class="button2" style="width:100%"><a href="{$smarty.const._DOMAIN_ROOT_URL}?m=user&f=user_buy&id={$arrTSI.id}" rel="modal:open" class="title" style="color:#006633">Đặt mua</a></button>
                        {else}
                        <button class="button2" style="width:100%"><a href="#" onClick="alert('Thời gian 14h45 đến 15h45 là khoảng thời gian chúng tôi không thực hiện lệnh mua')" class="title" style="color:#006633">Đặt mua</a></button>
                        {/if}
                     {else}<button class="button2" style="width:100%"><a href="{$smarty.const._DOMAIN_ROOT_URL}?m=user&f=userinfo" rel="modal:open" class="title" style="color:#006633">Đặt mua</a></button>{/if}
                  ...
                  {foreach key=key item=item from=$arrUserorder}
                    {if $item.model>0}
                      <tr bgcolor="{cycle values="#ffffff,#F4F4F4"}">
                        ...
                        <td class="title" align="right" {if ($arrTSI.giadvdt-$item.price)>0} style="color:#0000CC;  vertical-align: middle;" {else} style="color:#FF0000" {/if}>{format_number number=($arrTSI.giadvdt-$item.price)*$item.model}</td>
                        ...
                        <a href="{$smarty.const._DOMAIN_ROOT_URL}?m=user&f=user_sell&id={$key}&loai=1" rel="modal:open" class="title" style="color:#006633">Đặt bán</a>
                        {else}
                        <a href="#" onClick="alert('Quý khách vui lòng đặt lệnh vào khoảng thời gian từ  15h30h đến 23h59 ngày từ thứ 2 đến thứ 6 hàng tuần')" class="title" style="color:#006633">Đặt bán</a>
                        {/if}
                   ...
                   <tr height="40px">
                    ...
                    <td   {if ($arrTSI.giadvdt-($tonggiatrimua/$tongsoluongdvdt))>0} style="color:#0000CC; text-align: right; vertical-align: middle;" {else} style="color:#FF0000; text-align: center; vertical-align: middle;" {/if}><strong>{format_number number=$tonglailo}</strong></td>
                    <td  {if ($arrTSI.giadvdt-($tonggiatrimua/$tongsoluongdvdt))>0} style="color:#0000CC; text-align: right; vertical-align: middle;" {else} style="color:#FF0000; text-align: center; vertical-align: middle;" {/if} ><strong>{format_number2 number=(($arrTSI.giadvdt-($tonggiatrimua/$tongsoluongdvdt))/$item.price*100)}%</strong></td>
                    <td  style="vertical-align: middle; text-align:right"></td>
                  </tr>
                </table>
                <div class="row">
                	<div class="title" style="text-transform:uppercase; font-size:14px; padding-left:20px">Giao dịch mua</div>
                	<div>{userxacthucmua456}</div>
                </div>
                <div class="row">
                	<div class="title" style="text-transform:uppercase; font-size:14px; padding-left:20px">Giao dịch bán</div>
                    <div class="hidden-sm-down">{userxacthucban456pc}</div>
                    <div class="hidden-md-up">{userxacthucban456}</div> 
                </div>
