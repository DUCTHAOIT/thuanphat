...
<div class="modal fade" id="exampleModalIn" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    ...
    hidefocus="true" tabindex="-1"/>
            <div id="loginErrorBox" class="alert alert-danger" style="margin-bottom:10px;{if !$login_error} display:none;{/if}">{$login_error}</div>
...
{if $login_error}
<script>$(document).ready(function(){ $('#exampleModalIn').modal('show'); });</script>
{/if}
{literal}
    <style>
        .waiting-overlay {
