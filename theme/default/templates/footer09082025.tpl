        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form name="frmRegisterUser" action="{$smarty.const._DOMAIN_ROOT_URL}/?m=user" method="post" enctype="multipart/form-data">
                    ...
                    {else}
                        <div><input placeholder="Mã giới thiệu (số điện thoại của tài khoản giới thiệu)" type="text" name="gioithieu" class="text" /></div>
                    {/if}
                    ...
                    <div ><input type="checkbox" id="myCheck" name="option" onclick="myFunction()" value="false">
                        <label for="myCheck" style="cursor:pointer" >Đồng ý với Chính sách & Bảo mật</label></div>
