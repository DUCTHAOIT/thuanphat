...
<?php	
	...
	?>
         ...
         <li class=" level1 has-sub" ><a id="a<?php echo $key;?>" class="title"  style="text-decoration:none" href="<?php echo _DOMAIN_ROOT_URL."/".$arr[0][$key]["htaccess"]; ?>"><?php echo $arr[0][$key]["name"];?></a>
         	<ul>
            	<?php 
				foreach($arr[$key] as $k=>$v){
				?>
					<li class=" level2"><a  style="text-decoration:none;" class="content"  href="<?php echo _DOMAIN_ROOT_URL."/".$arr[$key][$k]["htaccess"]; ?>" ><?php echo $arr[$key][$k]["name"];?></a>	</li>			
				<?php
	...
	$j=$j+1;
		 ...
		 <li class=" level1 has-sub"><a id="a<?php echo $key;?>" class="title"  style="text-decoration:none" href="<?php echo _DOMAIN_ROOT_URL."/".$arr[0][$key]["htaccess"]; ?>"><?php echo $arr[0][$key]["name"];?></a></li>
	<?php	
	}		
	$j=$j+1;
	}
