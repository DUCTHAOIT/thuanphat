                  ...
                  {foreach key=key item=item from=$arrUserSohuu}
                    {if $item.model>0}
                      <tr bgcolor="{cycle values="#ffffff,#F4F4F4"}">
                        ...
                        <td class="title" align="right" style="vertical-align: middle;">{format_number number=$item.price_old}</td>
                        ...
                        <td class="title" align="right" {if ($arrTSI.giadvdt-$item.price)>0} style="color:#0000CC; vertical-align: middle;" {else} style="color:#FF0000; vertical-align: middle;" {/if}>{format_number2 number=((($arrTSI.giadvdt-$item.price)*$item.model)/$item.price_old*100)}%</td>
                      </tr>
                    
                      {assign var="totalmodel" value="`$totalmodel+$item.model`"}
                      {assign var="totalprice_old" value="`$totalprice_old+$item.price_old`"}
                      {assign var="lailo" value="`$lailo+(($arrTSI.giadvdt-$item.price)*$item.model)`"}
