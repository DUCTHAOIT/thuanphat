...
<div class="container" style="padding-bottom:30px;">
	...
	<div class="row" style="padding-top:30px">
			...
			<div class="col-xs-12 col-sm-4 col-md-4">
				...
				<div style="text-align: left; padding-top:10px;" class="h4">Tổng số sản phẩm: {$totalquantity}<input type="hidden" name="quantity" value="{$totalquantity}" /></div>
				<div style="text-align: left;" class="h4">Tổng tiền: &nbsp;&nbsp;{format_number number=$total}<input type="hidden" name="tong" value="{$total}" /></div>
				...
				<div id="logreg-forms">
					...
					<div name="loginForm"  class="form-horizontal&#x20;form-signin" id="form-signin" >
						...
						{*<div class="wt-btn wt-btn--outline wt-width-full" type="submit" data-skip-bin-overlay="true" id="btn-signup" style="margin-bottom:20px">
							Continue as a guest
						</div>*}
				...
				<div>
					...
					<div class="card-body text-center">
						...
						<p>Ngân hàng: TPBank<br>Số tài khoản: <strong>0908101082</strong></p>*}
					</div>
				</div>
				<div>
