...
<table id=table1 width="100%" border="0" cellpadding="0" cellspacing="0"> 
	...
	?>				
						 ...
						 <tr height="30px">
							<td  nowrap="nowrap" class="menuleftoff"><a style="font-weight:400; font-size:16px;"  href="<?php echo _DOMAIN_ROOT_URL."/".$arr[0][$key]["htaccess"] ?>"  class="title" ><?php echo $arr[0][$key]["name"] ?></a><div style="width:0px; height:0px; display:none" ><a href="#"  id="a<?php echo $key ?>"></a></div></td>     
						</tr>  
									...
									<tr  height="28" >										
										...
										<table width="100%" border="0" cellspacing="0" cellpadding="0">
											<tr height="30">											
                                             ...
                                             <td  nowrap="nowrap" style="padding-left:20px; border-bottom:1px solid #e1e1e1; font-size:12px;  font-weight:bold;" id="a<?php echo $k ?>" class="menuleftoff">
								...
								?>
									<tr  height="28">										
										<td align="left" width="100%">
											<table width="100%" border="0" cellspacing="0" cellpadding="0">
											  <tr>
												<td  nowrap="nowrap" style="font-size:12px; font-weight:bold;" class="menuleftoffsub"><a  href="<?php echo _DOMAIN_ROOT_URL."/".$arr[$key][$k]["htaccess"] ?>" class="content" style="font-size:12px;" id="a<?php echo $k ?>" ><?php echo $arr[$key][$k]["name"] ?></a></td>												
											  </tr>
											</table>
										</td>
									</tr>
			...
			<?php }else{ // menu cap 1 khong co link?>
					 <tr height="30px">
							<td  class="menuleftoff" nowrap="nowrap"  ><a style="font-weight:400; font-size:16px;"  href="<?php echo _DOMAIN_ROOT_URL."/".$arr[0][$key]["htaccess"] ?>"  class="title" id="a<?php echo $key ?>"><?php echo $arr[0][$key]["name"] ?></a></td>     
						</tr>  
					<?php 
				}			
		}
