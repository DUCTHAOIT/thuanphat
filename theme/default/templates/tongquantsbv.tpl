...
<main>
    ...
    <div class="introduce container flex">
        ...
        <div class="introduce__video">
            <video controls>
                <source src="{$smarty.const._DOMAIN_ROOT_URL}/image/TSBV.mp4" type="video/mp4">
            </video>
        </div>
    </div>
    <div class="characteristics">
        <div class="container">
            <h2 class="title">THẠCH SANH BỀN VỮNG – TSBV</h2>
            <ul class="characteristics__list flex">
                <li>
                    <div class="icon flex-center"><img src="{$smarty.const._DOMAIN_ROOT_URL}/assets/img/icon-dt1.png" alt=""></div>
                    <h5>DANH MỤC ĐA DẠNG</h5>
                    <p>Đầu tư vào cổ phiếu và trái phiếu</p>
                </li>
                <li>
                    <div class="icon flex-center"><img src="{$smarty.const._DOMAIN_ROOT_URL}/assets/img/icon-company.png" alt=""></div>
                    <h5>ĐẦU TƯ GIÁ TRỊ</h5>
                    <p>Tập trung vào các công ty có khả năng <br> tăng trưởng trong trung và dài hạn</p>
                </li>
                <li>
                    <div class="icon flex-center"><img src="{$smarty.const._DOMAIN_ROOT_URL}/assets/img/icon-mt.png" alt=""></div>
                    <h5>SINH LỜI HIỆU QUẢ</h5>
                    <p>Mục tiêu đầu tư 20-30%/ năm</p>
                </li>
                <li>
                    <div class="icon flex-center"><img src="{$smarty.const._DOMAIN_ROOT_URL}/assets/img/icon-invest.png" alt=""></div>
                    <h5>KHÔNG CẦN VỐN LỚN</h5>
                    <p>Vốn đầu tư tối thiểu 10 triệu đồng</p>
                </li>
                <li>
                    <div class="icon flex-center"><img src="{$smarty.const._DOMAIN_ROOT_URL}/assets/img/icon-db.png" alt=""></div>
                    <h5>ĐẦU TƯ AN TOÀN</h5>
                    <p>Không sử dụng đòn bảy tài chính <br> Quản trị rủi ro ưu việt</p>
                </li>
                <li>
                    <div class="icon flex-center"><img src="{$smarty.const._DOMAIN_ROOT_URL}/assets/img/icon-rr1.png" alt=""></div>
                    <h5>THANH KHOẢN LINH HOẠT</h5>
                    <p>Rút tiền hàng ngày</p>
                </li>
            </ul>
        </div>
    </div>
    <div class="service bg-gray">
        <div class="container">
            ...
            <div class="flex">
                <div class="col-left">
                    <h4>ĐẦU TƯ BỀN VỮNG (TSBV) - Ngày {$arrTSI2.date}</h4>
                    ...
                    <div class="percent flex-center"> {if (($arrTSI2.giadvdt-$arrTSITangGiam2.giadvdt))>0}<font><i class="fal fa-long-arrow-up"></i>{format_number2 number=($arrTSI2.giadvdt-$arrTSITangGiam2.giadvdt)/$arrTSITangGiam2.giadvdt*100}<sup>%</sup></font>{else}<font style="color:#FF0000"><i class="fal fa-long-arrow-down"></i>{format_number2 number=($arrTSI2.giadvdt-$arrTSITangGiam2.giadvdt)/$arrTSITangGiam2.giadvdt*100}<sup>%</sup></font>{/if}</div>
                    <div class="box-btn">
    ...
    <div class="report report--cs">
        <div class="container">
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane fade" id="report2">{$danhmucdttsbv}</div>
