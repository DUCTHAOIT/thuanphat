...
<div class="slider variable-width">
            ...
            <div>
            <div class="image"><img class="image-size" src='{$smarty.const._DOMAIN_ROOT_URL}/image.php?width=800&image={$smarty.const._DOMAIN_ROOT_URL}/images/gopvon/{$item.img}'></div>
            </div>
...
<div class="container" align="center" style="padding-top:10px">
			<a class="text-capitalize" href="{$view360}" target="_blank">
							<img  width="30px" src='{$smarty.const._DOMAIN_ROOT_URL}/images/360.png'>
							<span class="small">Virtual 360</span>
			</a>
</div>
{/if}        
{literal}
