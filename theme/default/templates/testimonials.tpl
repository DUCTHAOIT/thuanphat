...
{foreach key=key item=item from=$arr}
    ...
    <div class="col-xl-4 col-lg-4">
        <div class="intro-giangvien nonemb">
        	<a class="infoleader-item infoleader-item-blur link-view-giangvien" data-name="" data-intro="" data-class="" data-title="" data-img="" href="{$smarty.const._DOMAIN_ROOT_URL}/img/worldwide/{$item.img}" style="color:#FFFFFF">
            ...
            <div id="name-giangvien" data-name="{$item.img}" data-img="{$smarty.const._DOMAIN_ROOT_URL}/img/worldwide/{$item.img}" data-class="" data-title="{$item.name}">{$item.name}</div>
            </h3>
            <div class="infoleader-intro" id="titlegiangvien">{$item.address}</div>
            <div class="combo-line-hlv"></div>
            <div class="infoleader-intro" id="introgiangvien">{$item.des}</div>
            </a>
        </div>
    </div>
    <div class="col-xl-4 col-lg-4">
        <div class="item-recruit">
            ...
            <a class="infoleader-item infoleader-item-blur link-view-giangvien" data-name="" data-intro="" data-class="" data-title="" data-img="" href="{$smarty.const._DOMAIN_ROOT_URL}/img/worldwide/{$item.img}">
            <img id="imggiangvien" src="{$smarty.const._DOMAIN_ROOT_URL}/img/worldwide/{$item.img}" alt="" class="hvr-grow"  width="100%">
            ...
            <div class="intro-giangvien-mb nonepc">
                <a class="infoleader-item infoleader-item-blur link-view-giangvien" data-name="" data-intro="" data-class="" data-title="" data-img="" href="{$smarty.const._DOMAIN_ROOT_URL}/img/worldwide/{$item.img}" style="color:#FFFFFF">
                <h3 class="infoleader-name color-white title" style="text-transform:uppercase;">
                <div id="name-giangvien-mb" data-name="{$item.img}" data-img="{$smarty.const._DOMAIN_ROOT_URL}/img/worldwide/{$item.img}" data-class="" data-title="{$item.name}">1{$item.name}</div>
                </h3>
                <div class="infoleader-intro" id="introgiangvien-mb">{$item.des}</div>
                </a>
            </div>
...
<div class="img-thumb-giangvien"><a href="javascript:void(0)" data-link="{$smarty.const._DOMAIN_ROOT_URL}/{$item.htaccess}{$item.alias}" data-name="{$item.name}" data-title="{$item.address}" data-intro="{strstrimhlv str=$item.des}" data-class="" data-img="{$smarty.const._DOMAIN_ROOT_URL}/img/worldwide/{$item.img}"><img style="display:block; width:100%" class="" src="{$smarty.const._DOMAIN_ROOT_URL}/img/worldwide/{$item.img}" alt="{$item.name}"  width="100%"></a></div>
</div>
</div>
{assign var="i" value=$i+1}
