...
<div class="webwidget_tab" id="webwidget_tab">
    <div class="tabContainer">
        <ul class="tabHead">
            ...
            <li ><a href="javascript:;"><i class="fa fa-heart"></i> Tổng quan TSTT</a></li>
        ...
        <ul>
            <li class="tabCot" style="display: list-item;">
                <table width="100%" border="1" cellspacing="0" cellpadding="0" class="table">
                  <tr>
                    <td colspan="4" class="tr" style="text-transform:uppercase; background-color:#CCCCCC">Thông tin đầu tư tăng trưởng - Ngày {$arrTSI.date}</td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    {if $cmt}<button class="button2" style="width:120px"><a href="{$smarty.const._DOMAIN_ROOT_URL}?m=user&f=user_buy&id={$arrTSI.id}" rel="modal:open" class="title" style="font-size:14px; color:#006633">Đặt mua</a></button>{else}<button class="button2" style="width:120px"><a href="{$smarty.const._DOMAIN_ROOT_URL}?m=user&f=userinfo" rel="modal:open" class="title" style="font-size:14px; color:#006633">Đặt mua</a></button>{/if}
                    </td>
                  </tr>
                </table>
                  ...
                  {foreach key=key item=item from=$arrUserorder}
                    {if $item.model>0}
                      <tr bgcolor="{cycle values="#ffffff,#F4F4F4"}">
                        ...
                        <td class="title" align="right" {if ($arrTSI.giadvdt-$item.price)>0} style="color:#0000CC; text-align: center; vertical-align: middle;" {else} style="color:#FF0000; text-align: center; vertical-align: middle;" {/if}>{format_number number=($arrTSI.giadvdt-$item.price)*$item.model}</td>
                        ...
                        <td align="center" style="width:145px; text-align: center; vertical-align: middle;">  
                        <button class="button1" style="width:120px">
                        {if $ngayban=='1'}
