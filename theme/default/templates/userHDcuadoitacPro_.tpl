...
{/foreach}
{if $total < 500000000}{assign var="hoahong" value="`$total*0`"}{/if}
{if 500000000 < $total && $total < 1000000000}{assign var="hoahong" value="`$total*0.002`"}{/if}
{if 1000000000 < $total && $total < 3000000000}{assign var="hoahong" value="`$total*0.005`"}{/if}
{if 3000000000 < $total && $total < 5000000000}{assign var="hoahong" value="`$total*0.008`"}{/if}
{if 5000000000 < $total && $total < 10000000000}{assign var="hoahong" value="`$total*0.01`"}{/if}
{if 10000000000 < $total}{assign var="hoahong" value="`$total*0.012`"}{/if}
<tr>
