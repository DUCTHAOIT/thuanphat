<?php
/* Smarty version 3.1.36, created on 2025-09-03 08:49:16
  from '/www/wwwroot/thuanphatitc.vn/admin80/theme/default/templates/memberCreate.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.36',
  'unifunc' => 'content_68b79e9cc6d2c1_29897328',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'a664d726001c42733bb7da2c9e177b700794a95a' => 
    array (
      0 => '/www/wwwroot/thuanphatitc.vn/admin80/theme/default/templates/memberCreate.tpl',
      1 => 1754187764,
      2 => 'file',
    ),
  ),
...
function content_68b79e9cc6d2c1_29897328 (Smarty_Internal_Template $_smarty_tpl) {
...
" onchange="isValidEmail(document.frmCreateMember.txt_email.value)" /><label id="lbl_email" style="padding-left:10px; color:#FF0000"></label></td>
  </tr>
  <tr>
    <td align="right" nowrap="nowrap" style="padding-right:10px; padding-left:10px">&nbsp;</td>
    <td style="padding-left:10px; padding-left:10px"><input type="checkbox" name="chenge_pass" onclick="change_passworld(this.checked)" /><?php echo $_smarty_tpl->tpl_vars['Change_password']->value;?>
</td>
  </tr>
...
" name="txt_lastname" type="text" class="text" maxlength="50" /></td>
 ...
 <input name="dateYear" type="text" style="width:50px" maxlength="4" /></td>
  ...
  -->
  <tr>
    <td align="right" nowrap="nowrap" style="padding-right:10px; padding-left:10px"><?php echo $_smarty_tpl->tpl_vars['List_of_rights']->value;?>
</td>
    <td style="padding-left:10px; padding-left:10px">
	<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['getPermit'][0], array( array('sPermit'=>$_smarty_tpl->tpl_vars['arr']->value['permit']),$_smarty_tpl ) );?>
	</td>
  </tr>
  <tr>
