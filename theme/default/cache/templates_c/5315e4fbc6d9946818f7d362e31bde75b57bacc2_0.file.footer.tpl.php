<?php
/* Smarty version 3.1.36, created on 2026-07-12 04:47:29
  from 'C:\xampp\htdocs\thuanphatitc.vn\theme\default\templates\footer.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.36',
  'unifunc' => 'content_6a5300410342d9_02094424',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '5315e4fbc6d9946818f7d362e31bde75b57bacc2' => 
    array (
      0 => 'C:\\xampp\\htdocs\\thuanphatitc.vn\\theme\\default\\templates\\footer.tpl',
      1 => 1783824074,
      2 => 'file',
    ),
  ),
...
function content_6a5300410342d9_02094424 (Smarty_Internal_Template $_smarty_tpl) {
?><div class="container-fluid" style="padding:0px;">
    <?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['advertise_footer'][0], array( array(),$_smarty_tpl ) );?>
   
</div>
<div class="container-fluid" style="padding-top:30px;">
    <div class="row"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['advertise_button'][0], array( array(),$_smarty_tpl ) );?>
</div>     
</div>
</main>
<footer>
    <div class="container">
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-3 text-center" style="padding-bottom:20px;">
                  <div class="text-center"><center><a href=""><img src="<?php echo @constant('_DOMAIN_ROOT_URL');?>
/theme_images/footer/logo.png" style="width:80%" alt=""></a></center></div>
                  <div style="padding-top:20px; text-align:center" >CTY CỔ PHẦN TM QUỐC TẾ THUẬN PHÁT</div>
                  <div class="text-center" style="padding-top:10px"><center><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['weblink'][0], array( array(),$_smarty_tpl ) );?>
</center></div>
            </div>
          <div class="col-xs-12 col-sm-12 col-md-3" style="padding-top:20px">
            ...
            <div class="col-xs-12 col-sm-12 col-md-3" style="padding-top:20px; padding-bottom:20px; ">
           		<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['menu_button_default'][0], array( array(),$_smarty_tpl ) );?>
    ...
    <div class="row" style="border-top:1px solid #2fd7b3; margin-top:20px; padding:10px">
        <div class="container flex-lc" style="padding:10px">
            <div class="info" style="font-size:13px">Copyright © <?php echo @constant('_DOMAIN_ROOT_URL');?>
</div>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-header" style="position:relative">
      	<div style="width:100%" align="center"><img src="<?php echo @constant('_DOMAIN_ROOT_URL');?>
/theme_images/header/logo.png"  height="40px" alt=""></div>
      ...
      <div class="modal-body">
        <form name="loginForm" action="<?php echo @constant('_DOMAIN_ROOT_URL');?>
/?m=user" method="post">
			<input type="hidden" name="op" value="login" />
            <input type="hidden" name="ret_page" value="<?php echo $_smarty_tpl->tpl_vars['ret_page']->value;?>
" />
            <input type="hidden" name="mName" value="<?php echo $_smarty_tpl->tpl_vars['moduleName']->value;?>
" />
            <input  type="submit" name="update" value=" Apply " 
    style="position: absolute; height: 0px; width: 0px; border: none; padding: 0px;"
    hidefocus="true" tabindex="-1"/>
            <div id="loginErrorBox" class="alert alert-danger" style="margin-bottom:10px;<?php if (!$_smarty_tpl->tpl_vars['login_error']->value) {?> display:none;<?php }?>"><?php echo $_smarty_tpl->tpl_vars['login_error']->value;?>
</div>
...
echo '<script'; ?>
>$(document).ready(function(){ $('#exampleModalIn').modal('show'); });<?php echo '</script'; ?>
>
<?php }?>
...
function checkInputloginForm(){
	...
	$.post(obj.action, $(obj).serialize(), function(resp){
		if(resp.success){
			window.location.href = resp.redirect;
		}else{
			$('#loginErrorBox').text(resp.message).show();
		}
	}, 'json').fail(function(){
		obj.submit();
	});
...
<div class="modal fade" id="exampleModalOut" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header" style="position:relative">
                <div style="width:100%" align="center"><img src="<?php echo @constant('_DOMAIN_ROOT_URL');?>
/theme_images/header/logo.png"  height="60px" alt=""></div>
            ...
            <div class="modal-body">
                <form name="frmRegisterUser" action="<?php echo @constant('_DOMAIN_ROOT_URL');?>
...
" />
                    ...
                    <?php if ($_smarty_tpl->tpl_vars['affiliate_id']->value) {?>
                        <input type="hidden" name="gioithieu" value="<?php echo $_smarty_tpl->tpl_vars['affiliate_id']->value;?>
" />
                        <div><input placeholder="Mã giới thiệu" readonly value="Người giới thiệu: <?php echo $_smarty_tpl->tpl_vars['tennguoigiothieu']->value;?>
" type="text" name="nguoigioithieu" class="text" /></div>
                    ...
                    <?php }?>
                        ...
                        <label for="myCheck" style="cursor:pointer" >Đồng ý với <a href="<?php echo @constant('_DOMAIN_ROOT_URL');?>
...
<?php echo '<script'; ?>
 type='text/javascript' src='https://cdnjs.cloudflare.com/ajax/libs/slick-carousel/1.8.1/slick.min.js?ver=5.3.11'><?php echo '</script'; ?>
>
