<?php
/* Smarty version 3.1.36, created on 2026-07-16 17:01:58
  from 'C:\xampp\htdocs\thuanphatitc.vn\theme\default\templates\basket_list.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.36',
  'unifunc' => 'content_6a58f26633da00_55202155',
...
function content_6a58f26633da00_55202155 (Smarty_Internal_Template $_smarty_tpl) {
?>
...
<?php if ($_smarty_tpl->tpl_vars['arrProductBasket']->value) {?>
...
" />
				<div style="text-align: left; font-weight:700;" class="h4">Tổng số sản phẩm: <?php echo $_smarty_tpl->tpl_vars['totalquantity']->value;?>
<input type="hidden" name="quantity" value="<?php echo $_smarty_tpl->tpl_vars['totalquantity']->value;?>
" /></div>
				<div style="text-align: left; font-weight:700; padding-bottom:15px;" class="h4">Tổng tiền: &nbsp;&nbsp;<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['format_number'][0], array( array('number'=>$_smarty_tpl->tpl_vars['total']->value),$_smarty_tpl ) );?>
						...
						<div style="border:1px solid #e2e2e2; border-radius:6px; padding:12px; background:#fff;">
							...
							<div style="margin-top:8px;">
								...
								<label style="display:block; margin-bottom:6px;">
									...
									<strong style="color:#b45309;">Điểm thẻ tiêu dùng</strong> (số dư: <?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['format_number2'][0], array( array('number'=>$_smarty_tpl->tpl_vars['cardBalance']->value),$_smarty_tpl ) );?>
, tối đa <?php echo $_smarty_tpl->tpl_vars['cardPaymentPercent']->value;?>
% giá trị đơn)
								</label>
								<?php }?>
								<?php if ($_smarty_tpl->tpl_vars['acceptTichLuy']->value) {?>
								<label style="display:block; margin-bottom:6px;">
									<input type="checkbox" name="use_tich_luy" id="use_tich_luy" value="1" onchange="updatePaymentPreview()" <?php if ($_smarty_tpl->tpl_vars['tichLuyBalance']->value <= 0) {?>disabled<?php }?> />
									<strong style="color:#b45309;">Tích lũy tiêu dùng</strong> (số dư: <?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['format_number2'][0], array( array('number'=>$_smarty_tpl->tpl_vars['tichLuyBalance']->value),$_smarty_tpl ) );?>
)
								</label>
								<?php }?>
								...
								<label style="display:block; margin-bottom:6px;">
									...
									<strong style="color:#b45309;">Ví tiêu dùng</strong> (số dư: <?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['format_number2'][0], array( array('number'=>$_smarty_tpl->tpl_vars['tieuDungBalance']->value),$_smarty_tpl ) );?>
)
								</label>
								<?php }?>
								...
								<label style="display:block; margin-bottom:6px;">
									...
									<strong style="color:#b45309;">Ví khả dụng</strong> (số dư: <?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['format_number2'][0], array( array('number'=>$_smarty_tpl->tpl_vars['khaDungBalance']->value),$_smarty_tpl ) );?>
)
								</label>
								<?php }?>
								<?php if (!$_smarty_tpl->tpl_vars['acceptCard']->value && !$_smarty_tpl->tpl_vars['acceptTichLuy']->value && !$_smarty_tpl->tpl_vars['acceptTieuDung']->value && !$_smarty_tpl->tpl_vars['acceptKhaDung']->value) {?>
...
;
	var tpudTichLuyBalance = <?php echo (($tmp = @$_smarty_tpl->tpl_vars['tichLuyBalance']->value)===null||$tmp==='' ? 0 : $tmp);?>
;
...
<div class="container" style="padding-bottom:30px;">
	...
	<div class="col-xs-12 col-sm-12 col-md-12">
		<div class="card" style="background-color:#f3f4f6 !important; color:#1f2937 !important; border:1px solid #e2e2e2; border-radius:6px; padding:16px;">
			...
			<form method="get" action="<?php echo @constant('_DOMAIN_ROOT_URL');?>
/" style="display:flex; flex-wrap:wrap; gap:10px; align-items:flex-end; margin-bottom:16px;">
				...
				<div>
					...
					<select name="order_status" class="form-control" style="min-width:150px;">
						...
						<?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['orderStatusLabel']->value, 'st_label', false, 'st_key');
$_smarty_tpl->tpl_vars['st_label']->do_else = true;
if ($_from !== null) foreach ($_from as $_smarty_tpl->tpl_vars['st_key']->value => $_smarty_tpl->tpl_vars['st_label']->value) {
$_smarty_tpl->tpl_vars['st_label']->do_else = false;
?>
						<option value="<?php echo $_smarty_tpl->tpl_vars['st_key']->value;?>
" <?php if ($_smarty_tpl->tpl_vars['orderFilterStatus']->value == $_smarty_tpl->tpl_vars['st_key']->value) {?>selected<?php }?>><?php echo $_smarty_tpl->tpl_vars['st_label']->value;?>
</option>
						<?php
}
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
				...
				<div>
					...
					<input type="date" name="order_from" class="form-control" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['orderFilterFrom']->value, ENT_QUOTES, 'UTF-8', true);?>
">
				</div>
				<div>
					<label style="font-size:13px; color:#6b7280; display:block; margin-bottom:4px;">Đến ngày</label>
					<input type="date" name="order_to" class="form-control" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['orderFilterTo']->value, ENT_QUOTES, 'UTF-8', true);?>
">
				</div>
				<div style="display:flex; gap:8px;">
					<button type="submit" class="btn btn-primary">Lọc</button>
					<a href="<?php echo @constant('_DOMAIN_ROOT_URL');?>
/view_basket/" class="btn btn-secondary">Xóa lọc</a>
				</div>
			</form>

			<?php if ($_smarty_tpl->tpl_vars['ownOrders']->value) {?>
			...
			<table class="table table-bordered table-striped">
				...
				<tbody>
				<?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['ownOrders']->value, 'ord');
...
?>
				<tr>
					<td>#<?php echo $_smarty_tpl->tpl_vars['ord']->value['id'];?>
</td>
					<td><?php echo $_smarty_tpl->tpl_vars['ord']->value['created_at_fmt'];?>
</td>
					<td><strong><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['format_number'][0], array( array('number'=>$_smarty_tpl->tpl_vars['ord']->value['amount']),$_smarty_tpl ) );?>
</strong></td>
					<td><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['format_number'][0], array( array('number'=>$_smarty_tpl->tpl_vars['ord']->value['card_amount']),$_smarty_tpl ) );?>
</td>
					<td><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['format_number'][0], array( array('number'=>$_smarty_tpl->tpl_vars['ord']->value['tich_luy_amount']),$_smarty_tpl ) );?>
</td>
					<td><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['format_number'][0], array( array('number'=>$_smarty_tpl->tpl_vars['ord']->value['tieu_dung_amount']),$_smarty_tpl ) );?>
</td>
					<td><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['format_number'][0], array( array('number'=>$_smarty_tpl->tpl_vars['ord']->value['kha_dung_amount']),$_smarty_tpl ) );?>
</td>
					<td><strong><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['format_number'][0], array( array('number'=>$_smarty_tpl->tpl_vars['ord']->value['cash_amount']),$_smarty_tpl ) );?>
</strong></td>
					<td><?php echo $_smarty_tpl->tpl_vars['ord']->value['status_label'];?>
</td>
					<td>
						<button type="button" class="btn btn-sm btn-outline-primary" data-toggle="modal" data-target="#orderDetailModal<?php echo $_smarty_tpl->tpl_vars['ord']->value['id'];?>
">Xem chi tiết</button>
					</td>
				</tr>
				<?php
...
$_smarty_tpl->tpl_vars['ord']->do_else = false;
?>
<div class="modal fade" id="orderDetailModal<?php echo $_smarty_tpl->tpl_vars['ord']->value['id'];?>
" tabindex="-1" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title">Chi tiết đơn hàng #<?php echo $_smarty_tpl->tpl_vars['ord']->value['id'];?>
</h5>
			...
			<div class="modal-body">
				<table class="table table-bordered">
					...
					<tbody>
					<?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['ord']->value['items'], 'it');
...
?>
					<tr>
						...
						<td><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['format_number'][0], array( array('number'=>$_smarty_tpl->tpl_vars['it']->value['price']),$_smarty_tpl ) );?>
</td>
						<td><?php echo $_smarty_tpl->tpl_vars['it']->value['quantity'];?>
</td>
						<td><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['format_number'][0], array( array('number'=>$_smarty_tpl->tpl_vars['it']->value['price']*$_smarty_tpl->tpl_vars['it']->value['quantity']),$_smarty_tpl ) );?>
</td>
					</tr>
					<?php
}
