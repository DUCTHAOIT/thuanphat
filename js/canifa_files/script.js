  ...
  /* Coin Slider */
	...
	if (jQuery('#categories-accordion').length){
        ...
        if(mobileDevice == true){
            ...
            //jQuery('#categories-accordion li.active.level-top.parent .btn-cat').addClass('closed').next().slideToggle(200);
            jQuery('#categories-accordion li.active.level-top.parent .btn-cat').toggle(function(){
                jQuery(this).addClass('closed').next().slideToggle(200);
                jQuery(this).css('display','block');
            })
//			jQuery('#categories-accordion li.level-top.parent .btn-cat').each(function(){
            jQuery('#categories-accordion li.level-top.parent .btn-cat').click(function(){
                if(jQuery('#categories-accordion li.level-top.parent .btn-cat').hasClass('closed')){
                    jQuery('#categories-accordion li.level-top.parent .btn-cat').removeClass('closed');
                    jQuery('#categories-accordion li.level-top.parent ul.level0').hide();
                    jQuery(this).addClass('closed').next().fadeIn(200);
                    jQuery(this).next().show();
                }else{
                    jQuery('#categories-accordion li.level-top.parent ul.level0').hide();
                    jQuery(this).removeClass('closed').next().fadeIn(200);
                }
            });
//			});
        }
