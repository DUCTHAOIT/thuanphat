...
Product.OptionsPrice.prototype.updateSpecialPriceDisplay = function(price, finalPrice) {
    ...
    if (price == finalPrice) {
        ...
        //Fix for quick view        
        var qvfinalPrice = optionsPrice.formatPrice(finalPrice);
        jQuery('.price-box .price').text(qvfinalPrice);
    }else{
        ...
        var qvPrice = optionsPrice.formatPrice(finalPrice);
        jQuery('.special-price .price').text(qvPrice);
    }    
};
