...
function scaleBannerVideoSize(t) {
    var e, i, n = $(window).width(),
        o = $(window).height() + 5;
    $(t).each(function() {
        var t = $(this).data("height") / $(this).data("width");
        $(this).width(n), 1e3 > n && (i = o, e = i / t, $(this).css({
            "margin-top": 0,
            "margin-left": -(e - n) / 2 + "px"
        }), $(this).width(e).height(i)), $(".homepage-hero-module .video-container video").addClass("fadeIn animated")
    })
}
...
Vel = $ ? $.Velocity : jQuery ? jQuery.Velocity : Velocity, jQuery.Velocity ? console.log("Velocity is already loaded. You may be needlessly importing Velocity again; note that Materialize includes Velocity.") : (! function(t) {
        ...
        return function(t, e, i, n) {
            ...
            function l(t, i, n, o) {
                ...
                var k = x ? new Float32Array(b) : new Array(b),
                    S = !1,
                    T = function(e) {
                        return S || f(), t === i && n === o ? e : 0 === e ? 0 : 1 === e ? 1 : l(p(e), i, o)
                    };
                                    ...
                                    for (var A in C)
                                        if ("element" !== A) {
                                            ...
                                            if (1 === v) E = M.endValue;
                                                ...
                                                if (E = M.startValue + O * I(v, c, O), !f && E === M.currentValue) continue
                                            }
                                            if (M.currentValue = E, "tween" === A) g = E;
                                            else {
                                                ...
                                                x.Hooks.registered[A] && (s(S).rootPropertyValueCache[F] = x.Normalizations.registered[F] ? x.Normalizations.registered[F]("extract", null, D[1]) : D[1]), "transform" === D[0] && (T = !0)
                                            }
                                        }
                                    c.mobileHA && s(S).transformCache.translate3d === n && (s(S).transformCache.translate3d = "(0px, 0px, 0px)", T = !0), T && x.flushTransformCache(S)
                                }
                            }
                            c.display !== n && "none" !== c.display && (b.State.calls[a][2].display = !1), c.visibility !== n && "hidden" !== c.visibility && (b.State.calls[a][2].visibility = !1), c.progress && c.progress.call(r[1], r[1], v, Math.max(0, p + c.duration - e), p, g), 1 === v && h(a)
                        }
                }
            ...
            var C = function() {
                ...
                function o() {
                    function t(t) {
                        ...
                        if ("scroll" === E) {
                            ...
                            var O;
                            s(a).tweensContainer && s(a).isAnimating === !0 && (O = s(a).tweensContainer), d.each(g, function(t, e) {
                                if (RegExp("^" + x.Lists.colors.join("$|^") + "$").test(t)) {
                                    ...
                                    if (x.RegEx.isHex.test(o)) {
                                        for (var r = ["Red", "Green", "Blue"], l = x.Values.hexToRgb(o), c = s ? x.Values.hexToRgb(s) : n, u = 0; u < r.length; u++) {
                                            var d = [l[u]];
                                            a && d.push(a), c !== n && d.push(c[u]), g[t + r[u]] = d
                                        }
                                        delete g[t]
                                    }
                                }
                            ...
                            for (var z in g) {
                                ...
                                if (s(a).isSVG || "tween" === B || x.Names.prefixCheck(B)[1] !== !1 || x.Normalizations.registered[B] !== n) {
                                    (r.display !== n && null !== r.display && "none" !== r.display || r.visibility !== n && "hidden" !== r.visibility) && /opacity|filter/.test(z) && !H && 0 !== V && (H = 0), r._cacheValues && O && O[z] ? (H === n && (H = O[z].endValue + O[z].unitType), N = s(a).rootPropertyValueCache[B]) : x.Hooks.registered[z] ? H === n ? (N = x.getPropertyValue(a, B), H = x.getPropertyValue(a, z, N)) : N = x.Hooks.templates[B][1] : H === n && (H = x.getPropertyValue(a, z));
                                    var j, $, q, Y = !1;
                                    if (j = p(z, H), H = j[0], q = j[1], j = p(z, V), V = j[0].replace(/^([+-\/*])=/, function(t, e) {
                                            return Y = e, ""
                                        }), $ = j[1], H = parseFloat(H) || 0, V = parseFloat(V) || 0, "%" === $ && (/^(fontSize|lineHeight)$/.test(z) ? (V /= 100, $ = "em") : /^scale/.test(z) ? (V /= 100, $ = "") : /(Red|Green|Blue)$/i.test(z) && (V = V / 100 * 255, $ = "")), /[\/*]/.test(Y)) $ = q;
                                    else if (q !== $ && 0 !== H)
                                        if (0 === V) $ = q;
                                        else {
                                            o = o || v();
                        ...
                        l.element && (x.Values.addClass(a, "velocity-animating"), R.push(l), "" === r.queue && (s(a).tweensContainer = l, s(a).opts = r), s(a).isAnimating = !0, S === k - 1 ? (b.State.calls.push([R, f, r, null, A.resolver]), b.State.isTicking === !1 && (b.State.isTicking = !0, u())) : S++)
                    }
                    var o, a = this,
                ...
                var r, l, p, f, g, y, w = arguments[0] && (arguments[0].p || d.isPlainObject(arguments[0].properties) && !arguments[0].properties.names || m.isString(arguments[0].properties));
                if (m.isWrapped(this) ? (r = !1, p = 0, f = this, l = this) : (r = !0, p = 1, f = w ? arguments[0].elements || arguments[0].e : arguments[0]), f = a(f)) {
                    w ? (g = arguments[0].properties || arguments[0].p, y = arguments[0].options || arguments[0].o) : (g = arguments[p], y = arguments[p + 1]);
                    var k = f.length,
                        S = 0;
                    if (!/^(stop|finish)$/i.test(g) && !d.isPlainObject(y)) {
                        var T = p + 1;
                        y = {};
                        for (var P = T; P < arguments.length; P++) m.isArray(arguments[P]) || !/^(fast|normal|slow)$/i.test(arguments[P]) && !/^\d/.test(arguments[P]) ? m.isString(arguments[P]) || m.isArray(arguments[P]) ? y.easing = arguments[P] : m.isFunction(arguments[P]) && (y.complete = arguments[P]) : y.duration = arguments[P]
                    }
                    var A = {
                        promise: null,
                        resolver: null,
                            ...
                            return d.each(b.State.calls, function(t, e) {
                                e && d.each(e[1], function(i, o) {
                                    ...
                                    return a === !0 || e[2].queue === a || y === n && e[2].queue === !1 ? void d.each(f, function(i, n) {
                                        ...
                                        }), d.queue(n, m.isString(y) ? y : "", [])), "stop" === g ? (s(n) && s(n).tweensContainer && a !== !1 && d.each(s(n).tweensContainer, function(t, e) {
                                            e.endValue = e.currentValue
                                        }), M.push(t)) : "finish" === g && (e[2].duration = 1))
                                    }) : !0
                                })
                            }), "stop" === g && (d.each(M, function(t, e) {
                                h(e, !0)
                            ...
                            if (!d.isPlainObject(g) || m.isEmptyObject(g)) {
                                if (m.isString(g) && b.Redirects[g]) {
                                    var I = d.extend({}, y),
                                        O = I.duration,
                                        F = I.delay || 0;
                                    return I.backwards === !0 && (f = d.extend(!0, [], f).reverse()), d.each(f, function(t, e) {
                                        parseFloat(I.stagger) ? I.delay = F + parseFloat(I.stagger) * t : m.isFunction(I.stagger) && (I.delay = F + I.stagger.call(e, t, k)), I.drag && (I.duration = parseFloat(O) || (/^(callout|transition)/.test(g) ? 1e3 : v), I.duration = Math.max(I.duration * (I.backwards ? 1 - t / k : (t + 1) / k), .75 * I.duration, 200)), b.Redirects[g].call(e, e, I || {}, t, k, f, A.promise ? A : n)
                                    }), t()
                                }
                                var L = "Velocity: First argument (" + g + ") was not a property map, a known action, or a registered redirect. Aborting.";
                    ...
                    if (I.loop = parseInt(I.loop), z = 2 * I.loop - 1, I.loop)
                        for (var _ = 0; z > _; _++) {
                            ...
                            _ === z - 1 && (V.display = I.display, V.visibility = I.visibility, V.complete = I.complete), C(f, "reverse", V)
                        }
                    return t()
                }
            };
    ...
    function() {
        ...
        var n = i.helpers = {},
            ...
            S = (n.cancelAnimFrame = function() {
                ...
                var s = 0,
                    ...
                    l = function() {
                        ...
                        var i = s / e,
                            c = r(i);
                        t.call(a, c, i, s), n.call(a, c, i), e > s ? a.animationFrame = k(l) : o.apply(a)
                    };
                k(l)
            ...
            E = n.getMaximumHeight = function(t) {
                var e = t.parentNode,
                    i = parseInt(M(e, "padding-bottom")) + parseInt(M(e, "padding-top"));
                return e.clientHeight - i
            },
            M = n.getStyle = function(t, e) {
            ...
            D = n.drawRoundedRectangle = function(t, e, i, n, o, a) {
        ...
        i.instances = {}, i.Type = function(t, e, n) {
            ...
            draw: function() {
                ...
                if (t.fillStyle = this.fillColor, this.custom) this.custom(this);
                    ...
                    D(t, a, s, i, n, this.cornerRadius), t.fill(), t.fillStyle = this.textColor, t.textAlign = "center", t.textBaseline = "middle", t.fillText(this.text, a + i / 2, s + n / 2)
                }
            }
        }), i.MultiTooltip = i.Element.extend({
            initialize: function() {
                this.font = F(this.fontSize, this.fontStyle, this.fontFamily), this.titleFont = F(this.titleFontSize, this.titleFontStyle, this.titleFontFamily), this.titleHeight = this.title ? 1.5 * this.titleFontSize : 0, this.height = this.labels.length * this.fontSize + (this.labels.length - 1) * (this.fontSize / 2) + 2 * this.yPadding + this.titleHeight, this.ctx.font = this.titleFont;
            ...
            calculateXLabelRotation: function() {
                ...
                if (this.xScalePaddingRight = n / 2 + 3, this.xScalePaddingLeft = i / 2 > this.yLabelWidth ? i / 2 : this.yLabelWidth, this.xLabelRotation = 0, this.display) {
                    var o, a = L(this.ctx, this.font, this.xLabels);
                    this.xLabelWidth = a;
            ...
            draw: function() {
                ...
                this.display && (t.fillStyle = this.textColor, t.font = this.font, o(this.yLabels, function(o, a) {
                    ...
                    0 !== i || s || (s = !0), s && t.beginPath(), i > 0 ? (t.lineWidth = this.gridLineWidth, t.strokeStyle = this.gridLineColor) : (t.lineWidth = this.lineWidth, t.strokeStyle = this.lineColor), s && (t.moveTo(o, this.endPoint), t.lineTo(o, this.startPoint - 3), t.stroke(), t.closePath()), t.lineWidth = this.lineWidth, t.strokeStyle = this.lineColor, t.beginPath(), t.moveTo(o, this.endPoint), t.lineTo(o, this.endPoint + 5),
                        t.stroke(), t.closePath(), t.save(), t.translate(n, a ? this.endPoint + 12 : this.endPoint + 8), t.rotate(-1 * y(this.xLabelRotation)), t.font = this.font, t.textAlign = a ? "right" : "center", t.textBaseline = a ? "middle" : "top", t.fillText(e, 0, 0), t.restore()
                }, this))
            }
            ...
            setScaleSize: function() {
                var t, e, i, n, o, a, s, r, l, c, u, h, d = g([this.height / 2 - this.pointLabelFontSize - 5, this.width / 2]),
                    p = this.width,
                    m = 0;
                for (this.ctx.font = F(this.pointLabelFontSize, this.pointLabelFontStyle, this.pointLabelFontFamily), e = 0; e < this.valuesCount; e++) t = this.getPointPosition(e, d), i = this.ctx.measureText(x(this.templateString, {
                    value: this.labels[e]
                })).width + 5, 0 === e || e === this.valuesCount / 2 ? (n = i / 2, t.x + n > p && (p = t.x + n, o = e), t.x - n < m && (m = t.x - n, s = e)) : e < this.valuesCount / 2 ? t.x + i > p && (p = t.x + i, o = e) : e > this.valuesCount / 2 && t.x - i < m && (m = t.x - i, s = e);
    ...
    function(t, e) {
        ...
        function o(t) {
            var e = d.call(t);
            return "[object String]" === e ? h(t) : i(t) && /^\[object (Array|HTMLCollection|NodeList|Object)\]$/.test(e) && t.hasOwnProperty("length") ? t : n(t) ? [t] : []
        }
        ...
        function a(t) {
            var i, n, o = {
                ...
                a = t && t.ownerDocument;
            return i = a.documentElement, "undefined" != typeof t.getBoundingClientRect && (o = t.getBoundingClientRect()), n = e(a), {
            ...
            f = {
                ...
                show: function(t, e, i) {
                    ...
                    var c = "scale(" + e.clientWidth / 100 * 3 + ")",
                        u = "translate(0,0)";
                    i && (u = "translate(" + i.x + "px, " + i.y + "px)"), n.setAttribute("data-hold", Date.now()), n.setAttribute("data-x", l), n.setAttribute("data-y", r), n.setAttribute("data-scale", c), n.setAttribute("data-translate", u);
                    var h = {
                        top: r + "px",
                        left: l + "px"
                    };
                    n.classList.add("waves-notransition"), n.setAttribute("style", s(h)), n.classList.remove("waves-notransition"), h["-webkit-transform"] = c + " " + u, h["-moz-transform"] = c + " " + u, h["-ms-transform"] = c + " " + u, h["-o-transform"] = c + " " + u, h.transform = c + " " + u, h.opacity = "1";
                    var d = "mousemove" === t.type ? 2500 : f.duration;
                    h["-webkit-transition-duration"] = d + "ms", h["-moz-transition-duration"] = d + "ms", h["-o-transition-duration"] = d + "ms", h["transition-duration"] = d + "ms", n.setAttribute("style", s(h))
                },
                hide: function(t, e) {
                    e = e || this;
                    for (var i = e.getElementsByClassName("waves-rippling"), n = 0, o = i.length; o > n; n++) r(t, e, i[n])
                }
            },
            m = {
                input: function(t) {
        ...
        return u.init = function(t) {
            ...
            for (var i, n, a = 0, s = t.length; s > a; a++) i = t[a], n = i.tagName.toLowerCase(), -1 !== ["input", "img"].indexOf(n) && (m[n](i), i = i.parentElement), -1 === i.className.indexOf("waves-effect") && (i.className += " waves-effect" + e)
        }, u.ripple = function(t, e) {
            t = o(t);
            var i = t.length;
            if (e = e || {}, e.wait = e.wait || 0, e.position = e.position || null, i)
                for (var n, s, r, l = {}, c = 0, u = {
                        type: "mousedown",
                        button: 1
                    }, h = function(t, e) {
                        return function() {
                    ...
                    if (n = t[c], s = e.position || {
                            x: n.clientWidth / 2,
                            y: n.clientHeight / 2
                        }, r = a(n), l.x = r.left + s.x, l.y = r.top + s.y, u.pageX = l.x, u.pageY = l.y, f.show(u, n), e.wait >= 0 && null !== e.wait) {
                        var d = {
                            type: "mouseup",
                            button: 1
                        };
                        setTimeout(h(d, n), e.wait)
                    }
        }, u.calm = function(t) {
            t = o(t);
            for (var e = {
        ...
        t(["jquery"], function(t) {
            return function() {
                ...
                function f(e) {
                    ...
                    function a() {
                        A.hover(C, x), !S.onclick && S.tapToDismiss && A.click(y), S.closeButton && O && O.click(function(t) {
                    ...
                    function s() {
                        A.hide(), A[S.showMethod]({
                            ...
                            easing: S.showEasing,
                            complete: S.onShown
                        }), S.timeOut > 0 && (P = setTimeout(y, S.timeOut), F.maxHideTime = parseFloat(S.timeOut), F.hideEta = (new Date).getTime() + F.maxHideTime, S.progressBar && (F.intervalId = setInterval(k, 10)))
                    }

                    function r() {
                        e.iconClass && A.addClass(S.toastClass).addClass(T)
                    }
                    ...
                    function c() {
                        e.title && (E.append(S.escapeHtml ? n(e.title) : e.title).addClass(S.titleClass), A.append(E))
                    }

                    function u() {
                        e.message && (M.append(S.escapeHtml ? n(e.message) : e.message).addClass(S.messageClass), A.append(M))
                    }

                    function h() {
                        S.closeButton && (O.addClass("toast-close-button").attr("role", "button"), A.prepend(O))
                    }
                    ...
                    function y(e) {
                        ...
                        return !t(":focus", A).length || e ? (clearTimeout(F.intervalId), A[i]({
                            duration: n,
                            easing: o,
                            complete: function() {
                                g(A), S.onHidden && "hidden" !== L.state && S.onHidden(), L.state = "hidden", L.endTime = new Date, p(L)
                            }
                        })) : void 0
                    }

                    function x() {
                        (S.timeOut > 0 || S.extendedTimeOut > 0) && (P = setTimeout(y, S.extendedTimeOut), F.maxHideTime = parseFloat(S.extendedTimeOut), F.hideEta = (new Date).getTime() + F.maxHideTime)
                    }

                    function C() {
                        clearTimeout(P), F.hideEta = 0, A.stop(!0, !0)[S.showMethod]({
                            duration: S.showDuration,
                            easing: S.showEasing
                        })
                    }
                    ...
                    function k() {
                        var t = (F.hideEta - (new Date).getTime()) / F.maxHideTime * 100;
                        I.width(t + "%")
                    }
                    var S = m(),
                        T = e.iconClass || S.iconClass;
                    if ("undefined" != typeof e.optionsOverride && (S = t.extend(S, e.optionsOverride), T = e.optionsOverride.iconClass || T), !f(S, e)) {
                        w++, v = i(S, !0);
                        var P = null,
                            A = t("<div/>"),
                            E = t("<div/>"),
                        ...
                        return o(), s(), a(), p(L), S.debug && console && console.log(L), A
                    }
                }
    ...
    function(t, e, i, n) {
        ...
        function w(t, e) {
            for (var i, o, a = e[0].toUpperCase() + e.slice(1), s = 0; s < dt.length;) {
                if (i = dt[s], o = i ? i + a : e, o in t) return o;
                s++
            }
            return n
        }
        ...
        function S(t) {
            ...
            return new(e = i ? i : kt ? V : St ? B : Ct ? j : _)(t, T)
        }
        ...
        function T(t, e, i) {
            var n = i.pointers.length,
                ...
                a = e & It && n - o === 0,
                s = e & (Ft | Lt) && n - o === 0;
            i.isFirst = !!a, i.isFinal = !!s, a && (t.session = {}), i.eventType = e, P(t, i), t.emit("hammer.input", i), t.recognize(i), t.session.prevInput = i
        }
        ...
        function P(t, e) {
            ...
            var a = i.firstInput,
                ...
                l = e.center = I(n);
            e.timeStamp = vt(), e.deltaTime = e.timeStamp - a.timeStamp, e.angle = D(r, l), e.distance = L(r, l), A(i, e), e.offsetDirection = F(e.deltaX, e.deltaY);
            var c = O(e.deltaTime, e.deltaX, e.deltaY);
            e.overallVelocityX = c.x, e.overallVelocityY = c.y, e.overallVelocity = gt(c.x) > gt(c.y) ? c.x : c.y, e.scale = s ? z(s.pointers, n) : 1, e.rotation = s ? R(s.pointers, n) : 0, e.maxPointers = i.prevInput ? e.pointers.length > i.prevInput.maxPointers ? e.pointers.length : i.prevInput.maxPointers : e.pointers.length, E(i, e);
            var u = t.element;
        ...
        function A(t, e) {
            var i = e.center,
                ...
                o = t.prevDelta || {},
                a = t.prevInput || {};
            (e.eventType === It || a.eventType === Ft) && (o = t.prevDelta = {
                x: a.deltaX || 0,
                y: a.deltaY || 0
            }, n = t.offsetDelta = {
                x: i.x,
        ...
        function E(t, e) {
            var i, o, a, s, r = t.lastInterval || e,
                l = e.timeStamp - r.timeStamp;
            if (e.eventType != Lt && (l > Mt || r.velocity === n)) {
                var c = e.deltaX - r.deltaX,
                    u = e.deltaY - r.deltaY,
                    h = O(l, c, u);
                o = h.x, a = h.y, i = gt(h.x) > gt(h.y) ? h.x : h.y, s = F(c, u), t.lastInterval = e
            } else i = r.velocity, o = r.velocityX, a = r.velocityY, s = r.direction;
        ...
        function F(t, e) {
            return t === e ? Dt : gt(t) >= gt(e) ? 0 > t ? Rt : zt : 0 > e ? _t : Vt
        }
        ...
        function R(t, e) {
            return D(e[1], e[0], jt) + D(t[1], t[0], jt)
        }

        function z(t, e) {
            return L(e[0], e[1], jt) / L(t[0], t[1], jt)
        }

        function _() {
            this.evEl = qt, this.evWin = Yt, this.pressed = !1, k.apply(this, arguments)
        }

        function V() {
            this.evEl = Zt, this.evWin = Gt, k.apply(this, arguments), this.store = this.manager.session.pointerEvents = []
        }

        function W() {
            this.evTarget = Kt, this.evWin = Jt, this.started = !1, k.apply(this, arguments)
        }

        function H(t, e) {
            var i = y(t.touches),
                n = y(t.changedTouches);
            return e & (Ft | Lt) && (i = b(i.concat(n), "identifier", !0)), [i, n]
        }
        ...
        function N(t, e) {
            var i = y(t.touches),
                n = this.targetIds;
            if (e & (It | Ot) && 1 === i.length) return n[i[0].identifier] = !0, [i, i];
            var o, a, s = y(t.changedTouches),
                r = [],
                l = this.target;
            ...
            for (o = 0; o < s.length;) n[s[o].identifier] && r.push(s[o]), e & (Ft | Lt) && delete n[s[o].identifier], o++;
        ...
        function j() {
            ...
            this.touch = new B(this.manager, t), this.mouse = new _(this.manager, t), this.primaryTouch = null, this.lastTouches = []
        }

        function $(t, e) {
            t & It ? (this.primaryTouch = e.changedPointers[0].identifier, q.call(this, e)) : t & (Ft | Lt) && q.call(this, e)
        }
        ...
        function Q(t) {
            ...
            var e = m(t, ue),
                i = m(t, he);
            return e && i ? ce : e || i ? e ? ue : he : m(t, le) ? le : re
        }
        ...
        function G(t) {
            this.options = ht({}, this.defaults, t || {}), this.id = x(), this.manager = null, this.options.enable = h(this.options.enable, !0), this.state = pe, this.simultaneous = {}, this.requireFail = []
        }
        ...
        function K(t) {
            return t == Vt ? "down" : t == _t ? "up" : t == Rt ? "left" : t == zt ? "right" : ""
        }
        ...
        function rt(t, e) {
            return e = e || {}, e.recognizers = h(e.recognizers, rt.defaults.preset), new lt(t, e)
        }

        function lt(t, e) {
            this.options = ht({}, rt.defaults, e || {}), this.options.inputTarget = this.options.inputTarget || t, this.handlers = {}, this.session = {}, this.recognizers = [], this.oldCssProps = {}, this.element = t, this.input = S(this), this.touchAction = new X(this, this.options.touchAction), ct(this, !0), s(this.options.recognizers, function(t) {
        ...
        function ct(t, e) {
            ...
            if (i.style) {
                var n;
                s(t.options.cssProps, function(o, a) {
        ...
        l(_, k, {
            handler: function(t) {
                var e = $t[t.type];
                e & It && 0 === t.button && (this.pressed = !0), e & Ot && 1 !== t.which && (e = Ft), this.pressed && (e & Ft && (this.pressed = !1), this.callback(this.manager, e, {
                    pointers: [t],
                    changedPointers: [t],
                    pointerType: At,
                    srcEvent: t
        ...
        t.MSPointerEvent && !t.PointerEvent && (Zt = "MSPointerDown", Gt = "MSPointerMove MSPointerUp MSPointerCancel"), l(V, k, {
            handler: function(t) {
                var e = this.store,
                    i = !1,
                ...
                o & It && (0 === t.button || s) ? 0 > r && (e.push(t), r = e.length - 1) : o & (Ft | Lt) && (i = !0), 0 > r || (e[r] = t, this.callback(this.manager, o, {
                    pointers: e,
                    changedPointers: [t],
                    pointerType: a,
                    srcEvent: t
        ...
        l(W, k, {
            handler: function(t) {
                ...
                if (e === It && (this.started = !0), this.started) {
                    ...
                    e & (Ft | Lt) && i[0].length - i[1].length === 0 && (this.started = !1), this.callback(this.manager, e, {
                        pointers: i[0],
                        changedPointers: i[1],
                        pointerType: Tt,
                        srcEvent: t
        ...
        X.prototype = {
            set: function(t) {
                t == se && (t = this.compute()), ae && this.manager.element.style && de[t] && (this.manager.element.style[oe] = t), this.actions = t.toLowerCase().trim()
            },
            update: function() {
            ...
            preventDefaults: function(t) {
                ...
                return s && a ? void 0 : o || a && i & Wt || s && i & Ht ? this.preventSrc(e) : void 0
            },
        ...
        G.prototype = {
            ...
            emit: function(t) {
                ...
                var i = this,
                    n = this.state;
                ge > n && e(i.options.event + U(n)), e(i.options.event), t.additionalEvent && e(t.additionalEvent), n >= ge && e(i.options.event + U(n))
            },
            tryEmit: function(t) {
            ...
            process: function(t) {
                var e = this.state,
                    ...
                    n = e & (fe | me),
                    o = this.attrTest(t);
                return n && (i & Lt || !o) ? e | ye : n || o ? i & Ft ? e | ge : e & fe ? e | me : fe : be
            }
        }), l(et, tt, {
            defaults: {
                event: "pan",
            ...
            getTouchAction: function() {
                var t = this.options.direction,
                    e = [];
                return t & Wt && e.push(he), t & Ht && e.push(ue), e
            },
            directionTest: function(t) {
                var e = this.options,
                    ...
                    a = t.deltaX,
                    s = t.deltaY;
                return o & e.direction || (e.direction & Wt ? (o = 0 === a ? Dt : 0 > a ? Rt : zt, i = a != this.pX, n = Math.abs(t.deltaX)) : (o = 0 === s ? Dt : 0 > s ? _t : Vt, i = s != this.pY, n = Math.abs(t.deltaY))), t.direction = o, i && n > e.threshold && o & e.direction
            },
            attrTest: function(t) {
            ...
            process: function(t) {
                ...
                if (this._input = t, !n || !i || t.eventType & (Ft | Lt) && !a) this.reset();
                else if (t.eventType & It) this.reset(), this._timer = o(function() {
                    this.state = ve, this.tryEmit()
                }, e.time, this);
                else if (t.eventType & Ft) return ve;
                return be
            },
            reset: function() {
            ...
            emit: function(t) {
                this.state === ve && (t && t.eventType & Ft ? this.manager.emit(this.options.event + "up", t) : (this._input.timeStamp = vt(), this.manager.emit(this.options.event, this._input)))
            }
        }), l(ot, tt, {
            defaults: {
                event: "rotate",
            ...
            attrTest: function(t) {
                ...
                return i & (Wt | Ht) ? e = t.overallVelocity : i & Wt ? e = t.overallVelocityX : i & Ht && (e = t.overallVelocityY), this._super.attrTest.call(this, t) && i & t.offsetDirection && t.distance > this.options.threshold && t.maxPointers == this.options.pointers && gt(e) > this.options.velocity && t.eventType & Ft
            },
            emit: function(t) {
        ...
        lt.prototype = {
            ...
            recognize: function(t) {
                ...
                if (!e.stopped) {
                    ...
                    for (var a = 0; a < n.length;) i = n[a], e.stopped === xe || o && i != o && !i.canRecognizeWith(o) ? i.reset() : i.recognize(t), !o && i.state & (fe | me | ge) && (o = e.curRecognizer = i), a++
                }
            },
            get: function(t) {
        ...
        Ce.Hammer = rt, "function" == typeof define && define.amd ? define(function() {
            return rt
        ...
        var e = {
            init: function(e) {
                ...
                e = t.extend(i, e), t(this).each(function() {
                    ...
                    t("body").append(a), "left" == e.edge ? (o.css("left", -1 * (e.menuWidth + 10)), a.css({
                        left: 0
                    })) : (o.addClass("right-aligned").css("right", -1 * (e.menuWidth + 10)).css("left", ""), a.css({
                        right: 0
                    ...
                    a.on("click", function() {
                        ...
                        if ("touch" == n.gesture.pointerType) {
                            ...
                            if ("left" === e.edge && (a > e.menuWidth ? a = e.menuWidth : 0 > a && (a = 0)), "left" === e.edge) a < e.menuWidth / 2 ? r = !1 : a >= e.menuWidth / 2 && (r = !0), o.css("left", a - e.menuWidth);
                            else {
                                a < window.innerWidth - e.menuWidth / 2 ? r = !0 : a >= window.innerWidth - e.menuWidth / 2 && (r = !1);
                                var l = -1 * (a - e.menuWidth / 2);
                                l > 0 && (l = 0), o.css("right", l)
                            }
                            var c;
                            "left" === e.edge ? (c = a / e.menuWidth, t("#sidenav-overlay").velocity({
                                opacity: c
                            }, {
                                duration: 50,
                                queue: !1,
                                easing: "easeOutQuad"
                            })) : (c = Math.abs((a - window.innerWidth) / e.menuWidth), t("#sidenav-overlay").velocity({
                                opacity: c
                            }, {
                                duration: 50,
                                queue: !1,
                        ...
                        if ("touch" == i.gesture.pointerType) {
                            ...
                            s = !1, "left" === e.edge ? r && .3 >= n || -.5 > n ? (o.velocity({
                                left: 0
                            }, {
                                duration: 300,
                                queue: !1,
                                ...
                                right: 0,
                                left: ""
                            })) : (!r || n > .3) && (t("body").css("overflow", ""), o.velocity({
                                left: -1 * (e.menuWidth + 10)
                            }, {
                                duration: 200,
                                queue: !1,
                                ...
                                right: "",
                                left: 0
                            })) : (!r || -.3 > n) && (t("body").css("overflow", ""), o.velocity({
                                right: -1 * (e.menuWidth + 10)
                            }, {
                                duration: 200,
                                queue: !1,
                        ...
                        if (r === !0) r = !1, s = !1, i();
                            ...
                            t("body").css("overflow", "hidden"), t("body").append(a), "left" === e.edge ? (a.css({
                                width: "50%",
                                right: 0,
                                left: ""
                            }), o.velocity({
                        ...
                        t(this).click(function(s) {
                            if (!t(this).hasClass("disabled") && !t(this).hasClass("optgroup")) {
                                ...
                                o ? (t('input[type="checkbox"]', this).prop("checked", function(t, e) {
                                    return !e
                                }), r = i(u, t(this).index(), n), g.trigger("focus")) : (l.find("li").removeClass("active"), t(this).toggleClass("active"), g.val(t(this).text())), activateOption(l, t(this)), n.find("option").eq(a).prop("selected", r), n.trigger("change"), "undefined" != typeof e && e()
                            }
                            s.stopPropagation()
                        })
                    }), n.wrap(r);
                        ...
                        y = function(e) {
                            ...
                            if (13 != e.which || l.is(":visible")) {
                                ...
                                if (13 == e.which) {
                                    ...
                                    r && (t(r).trigger("click"), o || g.trigger("close"))
                                }
    ...
    function(t) {
        ...
        function e(a, s, l, d) {
            ...
            function f() {
                T.data(s, A).addClass(S.input).val(T.data("value") ? A.get("select", k.format) : a.value), k.editable || T.on("focus." + C.id + " click." + C.id, function(t) {
                    t.preventDefault(), A.open()
                }).on("keydown." + C.id, w), o(a, {
                    haspopup: !0,
                    expanded: !1,
                    readonly: !1,
                    owns: a.id + "_root"
            ...
            function g() {
                A.$holder.on({
                    ...
                    var e = t(this),
                        i = e.data(),
                        n = e.hasClass(S.navDisabled) || e.hasClass(S.disabled),
                        o = r();
            ...
            function v() {
                var e;
                k.hiddenName === !0 ? (e = a.name, a.name = "") : (e = ["string" == typeof k.hiddenPrefix ? k.hiddenPrefix : "", "string" == typeof k.hiddenSuffix ? k.hiddenSuffix : "_submit"], e = e[0] + a.name + e[1]), A._hidden = t('<input type=hidden name="' + e + '"' + (T.data("value") || a.value ? ' value="' + A.get("select", k.formatSubmit) + '"' : "") + ">")[0], T.on("change." + C.id, function() {
                    A._hidden.value = a.value ? A.get("select", k.formatSubmit) : ""
                })
            }
            ...
            function b(t) {
                t.stopPropagation(), T.addClass(S.target), A.$root.addClass(S.focused), A.open()
            }

            function w(t) {
                var e = t.keyCode,
                    i = /^(8|46)$/.test(e);
                return 27 == e ? (A.close(!0), !1) : void((32 == e || i || !C.open && A.component.key[e]) && (t.preventDefault(), t.stopPropagation(), i ? A.clear().close() : A.open()))
            }
            if (!a) return e;
            var x = !1,
                C = {
                ...
                A = P.prototype = {
                    ...
                    $node: T,
                    start: function() {
                        return C && C.start ? A : (C.methods = {}, C.start = !0, C.open = !1, C.type = a.type, a.autofocus = a == r(), a.readOnly = !k.editable, a.id = a.id || C.id, "text" != a.type && (a.type = "text"), A.component = new l(A, k), A.$root = t('<div class="' + S.picker + '" id="' + a.id + '_root" />'), m(), A.$holder = t(p()).appendTo(A.$root), g(), k.formatSubmit && v(), f(), k.containerHidden ? t(k.containerHidden).append(A._hidden) : T.after(A._hidden), k.container ? t(k.container).append(A.$root) : T.after(A.$root), A.on({
                            ...
                            close: k.onClose,
                            set: k.onSet
                        }), x = i(A.$holder[0]), a.autofocus && A.open(), A.trigger("start").trigger("render"))
                    },
                    render: function(e) {
                        return e ? (A.$holder = t(p()), g(), A.$root.html(A.$holder)) : A.$root.find("." + S.box).html(A.component.nodes(C.open)), A.trigger("render")
                    },
                    stop: function() {
                        return C.start ? (A.close(), A._hidden && A._hidden.parentNode.removeChild(A._hidden), A.$root.remove(), T.removeClass(S.input).removeData(s), setTimeout(function() {
                            T.off("." + C.id)
                        }, 0), a.type = C.type, a.readOnly = !1, A.trigger("stop"), C.methods = {}, C.start = !1, A) : A
                    },
                    open: function(i) {
                        return C.open ? A : (T.addClass(S.active), o(a, "expanded", !0), setTimeout(function() {
                            ...
                            var e = t.target;
                            e != a && e != document && 3 != t.which && A.close(e === A.$holder[0])
                        }).on("keydown." + C.id, function(i) {
                            var n = i.keyCode,
                                o = A.component.key[n],
                                a = i.target;
                            27 == n ? A.close(!0) : a != A.$holder[0] || !o && 13 != n ? t.contains(A.$root[0], a) && 13 == n && (i.preventDefault(), a.click()) : (i.preventDefault(), o ? e._.trigger(A.component.key.go, A, [e._.trigger(o)]) : A.$root.find("." + S.highlighted).hasClass(S.disabled) || (A.set("select", A.component.item.highlight), k.closeOnSelect && A.close(!0)))
                        })), A.trigger("open"))
                    },
                    close: function(t) {
                        return t && (k.editable ? a.focus() : (A.$holder.off("focus.toOpen").focus(), setTimeout(function() {
                        ...
                        }, 0), C.open ? (C.open = !1, x && u.css("overflow", "").css("padding-right", "-=" + n()), c.off("." + C.id), A.trigger("close")) : A
                    },
                    clear: function(t) {
                    ...
                    set: function(e, i, n) {
                        ...
                        if (n = s && t.isPlainObject(i) ? i : n || {}, e) {
                            s || (r[e] = i);
                            for (o in r) a = r[o], o in A.component.item && (void 0 === a && (a = null), A.component.set(o, a, n)), ("select" == o || "clear" == o) && T.val("clear" == o ? "" : A.get(o, k.format)).trigger("change");
                            A.render()
                        }
                    ...
                    on: function(e, i, n) {
                        ...
                        if (e) {
                            s || (r[e] = i);
                            for (o in r) a = r[o], n && (o = "_" + o), C.methods[o] = C.methods[o] || [], C.methods[o].push(a)
                        }
                        return A
                    },
                    off: function() {
                        var t, e, i = arguments;
                        for (t = 0, namesCount = i.length; t < namesCount; t += 1) e = i[t], e in C.methods && delete C.methods[e];
                        return A
                    },
        ...
        return e.klasses = function(t) {
            ...
            t.fn[i] = function(o, a) {
                var s = this.data(i);
                return "picker" == o ? s : s && "string" == typeof o ? e._.trigger(s[o], s, [a]) : this.each(function() {
                    var a = t(this);
    ...
    function(t) {
        ...
        i.prototype.set = function(t, e, i) {
            ...
            if ((!n || !n.nav && !n.defaultValue) && (!d && c.disabled(i) || d && c.disabled(i) && (m || o || s) || !d && (i.pick <= p.pick || i.pick >= f.pick)))
                for (d && !m && (!s && h > 0 || !o && 0 > h) && (h *= -1); c.disabled(i) && (Math.abs(h) > 1 && (i.month < u.month || i.month > u.month) && (i = u, h = h > 0 ? 1 : -1), i.pick <= p.pick ? (r = !0, h = 1, i = c.create([p.year, p.month, p.date + (i.pick === p.pick ? 0 : -1)])) : i.pick >= f.pick && (l = !0, h = -1, i = c.create([f.year, f.month, f.date + (i.pick === f.pick ? 0 : 1)])), !r || !l);) i = c.create([i.year, i.month, i.date + h]);
            return i
            ...
            return a.node("div", (i.selectYears ? v() + g() : g() + v()) + m() + m(1), i.klass.header) + a.node("table", f + a.node("tbody", a.group({
                min: 0,
                max: o - 1,
                i: 1,
                node: "tr",
    ...
    function() {
        ...
        function n(n, s) {
            function l(t, e) {
                ...
                if (!e || !(y - w > d || d > y + w)) {
                    ...
                    c && h.append(M.canvas), M.setHand(l, u, !e, !0), r.off(p).on(p, function(t) {
                        t.preventDefault();
                        var e = /^touch/.test(t.type),
                            i = (e ? t.originalEvent.touches[0] : t).pageX - o,
                            n = (e ? t.originalEvent.touches[0] : t).pageY - a;
                        (m || i !== l || n !== u) && (m = !0, M.setHand(i, n, !1, !0))
                    }), r.off(f).on(f, function(t) {
                        r.off(f), t.preventDefault();
                        var i = /^touch/.test(t.type),
                            n = (i ? t.originalEvent.changedTouches[0] : t).pageX - o,
                            c = (i ? t.originalEvent.changedTouches[0] : t).pageY - a;
                        (e || m) && n === l && c === u && M.setHand(n, c), "hours" === M.currentView ? M.toggleView("minutes", C / 2) : s.autoclose && (M.minutesView.addClass("clockpicker-dial-out"), setTimeout(function() {
                            M.done()
                        }, C / 2)), h.prepend(_), clearTimeout(g), M.popover.removeClass("clockpicker-moving"), r.off(p)
                    })
                }
            }
            var u = a(k),
                ...
                A = P ? n : n.find("input"),
                E = a("label[for=" + A.attr("id") + "]"),
                M = this;
            if (this.id = i("cp"), this.element = n, this.holder = m, this.options = s, this.isAppended = !1, this.isShown = !1, this.currentView = "hours", this.isInput = P, this.input = A, this.label = E, this.popover = u, this.plate = h, this.hoursView = g, this.minutesView = S, this.amPmBlock = T, this.spanHours = u.find(".clockpicker-span-hours"), this.spanMinutes = u.find(".clockpicker-span-minutes"), this.spanAmPm = u.find(".clockpicker-span-am-pm"), this.footer = u.find(".picker__footer"), this.amOrPm = "PM", s.twelvehour) {
                ...
                a(I), s.ampmclickable ? (this.spanAmPm.empty(), a('<div id="click-am">AM</div>').on("click", function() {
            ...
            var O, F, L, D, R = a('<div class="clockpicker-tick"></div>');
            if (s.twelvehour)
                for (O = 1; 13 > O; O += 1) F = R.clone(), L = O / 6 * Math.PI, D = y, F.css("font-size", "140%"), F.css({
                    left: v + Math.sin(L) * D - w,
                    top: v - Math.cos(L) * D - w
                }), F.html(0 === O ? "00" : O), g.append(F), F.on(d, l);
            else
                for (O = 0; 24 > O; O += 1) {
                    F = R.clone(), L = O / 6 * Math.PI;
                    var z = O > 0 && 13 > O;
                    D = z ? b : y, F.css({
                        left: v + Math.sin(L) * D - w,
                        top: v - Math.cos(L) * D - w
                    }), z && F.css("font-size", "120%"), F.html(0 === O ? "00" : O), g.append(F), F.on(d, l)
                }
            for (O = 0; 60 > O; O += 5) F = R.clone(), L = O / 30 * Math.PI, F.css({
                left: v + Math.sin(L) * y - w,
                top: v - Math.cos(L) * y - w
            }), F.css("font-size", "140%"), F.html(e(O)), S.append(F), F.on(d, l);
            if (h.on(d, function(t) {
                ...
                var j = t("circle");
                j.setAttribute("class", "clockpicker-canvas-fg"), j.setAttribute("r", 5), W.appendChild(B), W.appendChild(N), W.appendChild(j), W.appendChild(H), V.appendChild(W), _.append(V), this.hand = B, this.bg = N, this.fg = j, this.bearing = H, this.g = W, this.canvas = _
            }
            o(this.options.init)
        }
        ...
        n.DEFAULTS = {
            ...
            this.currentView = t, this.spanHours.toggleClass("text-primary", n), this.spanMinutes.toggleClass("text-primary", !n), r.addClass("clockpicker-dial-out"), s.css("visibility", "visible").removeClass("clockpicker-dial-out"), this.resetClock(e), clearTimeout(this.toggleViewTimer), this.toggleViewTimer = setTimeout(function() {
            ...
            var s, r = Math.atan2(t, -i),
                ...
                p = l && (y + b) / 2 > h,
                f = p ? b : y;
            if (d.twelvehour && (f = y), 0 > r && (r = 2 * Math.PI + r), s = Math.round(r / u), r = s * u, d.twelvehour ? l ? 0 === s && (s = 12) : (n && (s *= 5), 60 === s && (s = 0)) : l ? (12 === s && (s = 0), s = p ? 0 === s ? 12 : s : 0 === s ? 0 : s + 12) : (n && (s *= 5), 60 === s && (s = 0)), l ? this.fg.setAttribute("class", "clockpicker-canvas-fg") : s % 5 == 0 ? this.fg.setAttribute("class", "clockpicker-canvas-fg") : this.fg.setAttribute("class", "clockpicker-canvas-fg active"), this[this.currentView] !== s && m && this.options.vibrate && (this.vibrateTimer || (navigator[m](10), this.vibrateTimer = setTimeout(a.proxy(function() {
            ...
            o || !l && s % 5 ? (this.g.insertBefore(this.hand, this.bearing), this.g.insertBefore(this.bg, this.fg), this.bg.setAttribute("class", "clockpicker-canvas-bg clockpicker-canvas-bg-trans")) : (this.g.insertBefore(this.hand, this.bg), this.g.insertBefore(this.fg, this.bg), this.bg.setAttribute("class", "clockpicker-canvas-bg"));
            var g = Math.sin(r) * (f - w),
                v = -Math.cos(r) * (f - w),
                x = Math.sin(r) * f,
                C = -Math.cos(r) * f;
            this.hand.setAttribute("x2", g), this.hand.setAttribute("y2", v), this.bg.setAttribute("cx", x), this.bg.setAttribute("cy", C), this.fg.setAttribute("cx", x), this.fg.setAttribute("cy", C)
            ...
            return this.each(function() {
                ...
                if (o) "function" == typeof o[t] && o[t].apply(o, e);
                    ...
                    var s = a.extend({}, n.DEFAULTS, i.data(), "object" == typeof t && t);
                    i.data("clockpicker", new n(i, s))
                }
            })
        }
    }(), ! function(t, e) {
        ...
        var t = function(t, e, i, n) {
            var o = {
                ...
                detectFeatures: function() {
                    ...
                    for (var c, u, h = ["transform", "perspective", "animationName"], d = ["", "webkit", "Moz", "ms", "O"], p = 0; 4 > p; p++) {
                        i = d[p];
                        for (var f = 0; 3 > f; f++) c = h[f], u = i + (i ? c.charAt(0).toUpperCase() + c.slice(1) : c), !n[c] && u in e && (n[c] = u);
            ...
            o.extend(l, n);
            var c, u, h, d, p, f, m, g, v, y, b, w, x, C, k, S, T, P, A, E, M, I, O, F, L, D, R, z, _, V, W, H, B, N, j, $, q, Y, X, Q, Z, G, U, K, J, tt, et, it, nt, ot, at, st, rt, lt, ct, ut, ht = function() {
                    return {
                        x: 0,
                        y: 0
                    }
                ...
                Ft = function(t) {
                    nt && (t && (y > a.currItem.fitRatio ? kt || (hi(a.currItem, !1, !0), kt = !0) : kt && (hi(a.currItem), kt = !1)), Ot(nt, ft.x, ft.y, y))
                },
                Lt = function(t) {
                ...
                Nt = function() {
                    o.unbind(window, "resize", a), o.unbind(window, "scroll", v.scroll), o.unbind(document, "keydown", a), o.unbind(document, "mousemove", Ht), W.transform && o.unbind(a.scrollWrap, "click", a), Y && o.unbind(window, m, a), Et("unbindEvents")
                },
                jt = function(t, e) {
                ...
                ne = {
                    ...
                    setScrollOffset: function(t, e) {
                        vt.x = t, V = vt.y = e, Et("updateScrollOffset", vt)
                    },
                    applyZoomPan: function(t, e, i, n) {
                        ft.x = e, ft.y = i, y = t, Ft(n)
                    },
                    init: function() {
                        if (!c && !u) {
                            var i;
                            a.framework = o, a.template = t, a.bg = o.getChildByClass(t, "pswp__bg"), R = t.className, c = !0, W = o.detectFeatures(), L = W.raf, D = W.caf, I = W.transform, _ = W.oldIE, a.scrollWrap = o.getChildByClass(t, "pswp__scroll-wrap"), a.container = o.getChildByClass(a.scrollWrap, "pswp__container"), p = a.container.style, a.itemHolders = S = [{
                                ...
                                wrap: 0,
                                index: -1
                            }], S[0].el.style.display = S[2].el.style.display = "none", Xt(), v = {
                                resize: a.updateSize,
                                scroll: Gt,
                                keydown: Qt,
                                click: Zt
                            ...
                            var h = "pswp--open ";
                            for (l.mainClass && (h += l.mainClass + " "), l.showHideOpacity && (h += "pswp--animate_opacity "), h += F ? "pswp--touch" : "pswp--notouch", h += W.animationName ? " pswp--css_animation" : "", h += W.svg ? " pswp--svg" : "", o.addClass(t, h), a.updateSize(), f = -1, bt = null, i = 0; r > i; i++) Dt((i + f) * yt.x, S[i].el.style);
                            _ || o.bind(a.scrollWrap, g, a), At("initialZoomInEnd", function() {
                    ...
                    close: function() {
                        c && (c = !1, u = !0, Et("close"), Nt(), ei(a.currItem, null, !0, a.destroy))
                    },
                    destroy: function() {
                        Et("destroy"), Qe && clearTimeout(Qe), t.setAttribute("aria-hidden", "true"), t.className = R, C && clearInterval(C), o.unbind(a.scrollWrap, g, a), o.unbind(window, "scroll", a), Se(), ee(), Pt = null
                    },
                    panTo: function(t, e, i) {
                        i || (t > it.min.x ? t = it.min.x : t < it.max.x && (t = it.max.x), e > it.min.y ? e = it.min.y : e < it.max.y && (e = it.max.y)), ft.x = t, ft.y = e, Ft()
                    },
                    ...
                    goTo: function(t) {
                        t = Tt(t);
                        var e = t - d;
                        bt = e, d = t, a.currItem = Ke(d), gt -= e, Rt(yt.x * gt), ee(), ot = !1, a.updateCurrItem()
                    },
                    next: function() {
                        a.goTo(d + 1)
                    },
                    ...
                    updateCurrZoomItem: function(t) {
                        ...
                        it = a.currItem.bounds, b = y = a.currItem.initialZoomLevel, ft.x = it.center.x, ft.y = it.center.y, t && Et("afterChange")
                    },
                    ...
                    updateCurrItem: function(t) {
                        if (0 !== bt) {
                            var e, i = Math.abs(bt);
                            if (!(t && 2 > i)) {
                                a.currItem = Ke(d), kt = !1, Et("beforeChange", bt), i >= r && (f += bt + (bt > 0 ? -r : r), i = r);
                                for (var n = 0; i > n; n++) bt > 0 ? (e = S.shift(), S[r - 1] = e, f++, Dt((f + 2) * yt.x, e.el.style), a.setContent(e, d - i + n + 1 + 1)) : (e = S.pop(), S.unshift(e), f--, Dt(f * yt.x, e.el.style), a.setContent(e, d + i - n - 1 - 1));
                                if (nt && 1 === Math.abs(bt)) {
                                    var o = Ke(T);
                                    o.initialZoomLevel !== y && (ri(o, mt), hi(o), Lt(o))
                                }
                                bt = 0, a.updateCurrZoomItem(), T = d, Et("afterChange")
                            }
                        }
                    },
                    updateSize: function(e) {
                        ...
                        if (mt.x = a.scrollWrap.clientWidth, mt.y = a.scrollWrap.clientHeight, Gt(), yt.x = mt.x + Math.round(mt.x * l.spacing), yt.y = mt.y, Rt(yt.x * gt), Et("beforeResize"), void 0 !== f) {
                            for (var n, s, c, u = 0; r > u; u++) n = S[u], Dt((u + f) * yt.x, n.el.style), c = d + u - 1, l.loop && Je() > 2 && (c = Tt(c)), s = Ke(c), s && (k || s.needsUpdate || !s.bounds) ? (a.cleanSlide(s), a.setContent(n, c), 1 === u && (a.currItem = s, a.updateCurrZoomItem(!0)), s.needsUpdate = !1) : -1 === n.index && c >= 0 && a.setContent(n, c), s && s.container && (ri(s, mt), hi(s), Lt(s));
                            k = !1
                        }
                        b = y = a.currItem.initialZoomLevel, it = a.currItem.bounds, it && (ft.x = it.center.x, ft.y = it.center.y, Ft(!0)), Et("resize")
                    },
                    zoomTo: function(t, e, i, n, a) {
                        e && (b = y, be.x = Math.abs(e.x) - ft.x, be.y = Math.abs(e.y) - ft.y, _t(pt, ft));
                        var s = jt(t, !1),
                            r = {};
                        ...
                        Vt(r);
                        var u = function(e) {
                            1 === e ? (y = t, ft.x = r.x, ft.y = r.y) : (y = (t - l) * e + l, ft.x = (r.x - c.x) * e + c.x, ft.y = (r.y - c.y) * e + c.y), a && a(e), Ft(1 === e)
                        };
                ...
                Ve = function(t, e) {
                    var i, n, o, s, r = 0,
                        ...
                        h = ye.x + e.x,
                        d = ye.x - de.x;
                    return i = c > it.min[t] || c < it.max[t] ? l.panEndFriction : 1, c = ft[t] + e[t] * i, !l.allowPanToNext && y !== a.currItem.initialZoomLevel || (nt ? "h" !== at || "x" !== t || Q || (u ? (c > it.min[t] && (i = l.panEndFriction, r = it.min[t] - c, n = it.min[t] - pt[t]), (0 >= n || 0 > d) && Je() > 1 ? (s = h, 0 > d && h > de.x && (s = de.x)) : it.min.x !== it.max.x && (o = c)) : (c < it.max[t] && (i = l.panEndFriction, r = c - it.max[t], n = pt[t] - it.max[t]), (0 >= n || d > 0) && Je() > 1 ? (s = h, d > 0 && h < de.x && (s = de.x)) : it.min.x !== it.max.x && (o = c))) : s = h, "x" !== t) ? void(ot || U || y > a.currItem.fitRatio && (ft[t] += e[t] * i)) : (void 0 !== s && (Rt(s, !0), U = s === de.x ? !1 : !0), it.min.x !== it.max.x && (void 0 !== o ? ft.x = o : U || (ft.x += e.x * i)), void 0 !== s)
                },
                We = function(t) {
                    if (!("mousedown" === t.type && t.button > 0)) {
                        ...
                        if (!q || "mousedown" !== t.type) {
                            ...
                            var i = _e(t),
                                n = i.length;
                            K = null, ee(), Y && 1 !== n || (Y = st = !0, o.bind(window, m, a), j = ct = rt = $ = U = Z = X = Q = !1, at = null, Et("firstTouchStart", i), _t(pt, ft), dt.x = dt.y = 0, _t(ce, i[0]), _t(ue, ce), de.x = yt.x * gt, pe = [{
                                x: ce.x,
                                y: ce.y
                            }], B = H = Mt(), jt(y, !0), Se(), Te()), !J && n > 1 && !ot && !U && (b = y, Q = !1, J = X = !0, dt.y = dt.x = 0, _t(pt, ft), _t(se, i[0]), _t(re, i[1]), Oe(se, re, we), be.x = Math.abs(we.x) - ft.x, be.y = Math.abs(we.y) - ft.y, tt = et = ke(se, re))
                        }
                    }
                },
                He = function(t) {
                    ...
                    if (K) {
                        ...
                        if (0 !== t)
                            if (_t(se, K[0]), le.x = se.x - ce.x, le.y = se.y - ce.y, J && t > 1) {
                                ...
                                0 > n && (n = 0), tt = e, Oe(se, re, ge), dt.x += ge.x - we.x, dt.y += ge.y - we.y, _t(we, ge), ft.x = zt("x", i), ft.y = zt("y", i), j = i > y, y = i, Ft()
                            } else {
                                if (!at) return;
                ...
                Ne = function(t) {
                    ...
                    var u = -1;
                    if (0 === c && (Y = !1, o.unbind(window, m, a), Se(), J ? u = 0 : -1 !== ve && (u = Mt() - ve)), ve = 1 === c ? Mt() : -1, s = -1 !== u && 150 > u ? "zoom" : "swipe", J && 2 > c && (J = !1, 1 === c && (s = "zoomPointerUp"), Et("zoomGestureEnded")), K = null, Z || Q || ot || $)
                        if (ee(), N || (N = je()), N.calculateSwipeSpeed("x"), $) {
                            ...
                            if (h < l.verticalDragRange) a.close();
                                ...
                                ie("verticalDrag", 0, 1, 300, o.easing.cubic.out, function(t) {
                                    ft.y = (a.currItem.initialPosition.y - d) * t + d, It((1 - p) * t + p), Ft()
                                }), Et("onVerticalDrag", 1)
                            }
                        } else {
                            if ((U || ot) && 0 === c) {
                            ...
                            if (!ot) return "swipe" !== s ? void Xe() : void(!U && y > a.currItem.fitRatio && $e(N))
                        }
                },
                je = function() {
                    var t, e, i = {
                        ...
                        panAnimLoop: function() {
                            return Ut.zoomPan && (Ut.zoomPan.raf = L(i.panAnimLoop), i.now = Mt(), i.timeDiff = i.now - i.lastNow, i.lastNow = i.now, i.calculateAnimOffset("x"), i.calculateAnimOffset("y"), Ft(), i.calculateOverBoundsAnimOffset("x"), i.calculateOverBoundsAnimOffset("y"), i.speedDecelerationRatioAbs.x < .05 && i.speedDecelerationRatioAbs.y < .05) ? (ft.x = Math.round(ft.x), ft.y = Math.round(ft.y), Ft(), void Jt("zoomPan")) : void 0
                        }
                    };
                    return i
                },
                ...
                qe = function(t, e) {
                    ...
                    var c;
                    n && (d += n, 0 > d ? (d = l.loop ? Je() - 1 : 0, c = !0) : d >= Je() && (d = l.loop ? 0 : Je() - 1, c = !0), (!c || l.loop) && (bt += n, gt -= n, i = !0));
                    var u, h = yt.x * gt,
                        p = Math.abs(h - ye.x);
                    return i || h > ye.x == e.lastFlickSpeed.x > 0 ? (u = Math.abs(e.lastFlickSpeed.x) > 0 ? p / Math.abs(e.lastFlickSpeed.x) : 333, u = Math.min(u, 400), u = Math.max(u, 250)) : u = 333, me === d && (i = !1), ot = !0, Et("mainScrollAnimStart"), ie("mainScroll", ye.x, h, u, o.easing.cubic.out, Rt, function() {
                ...
                publicMethods: {
                    initGestures: function() {
                        var t = function(t, e, i, n, o) {
                            P = t + e, A = t + i, E = t + n, M = o ? t + o : ""
                        };
                        O = W.pointerEvent, O && W.touch && (W.touch = !1), O ? navigator.pointerEnabled ? t("pointer", "down", "move", "up", "cancel") : t("MSPointer", "Down", "Move", "Up", "Cancel") : W.touch ? (t("touch", "start", "move", "end", "cancel"), F = !0) : t("mouse", "down", "move", "up"), m = A + " " + E + " " + M, g = P, O && !F && (F = navigator.maxTouchPoints > 1 || navigator.msMaxTouchPoints > 1), a.likelyTouchDevice = F, v[P] = We, v[A] = He, v[E] = Ne, M && (v[M] = v[E]), W.touch && (g += " mousedown", m += " mousemove mouseup", v.mousedown = v[P], v.mousemove = v[A], v.mouseup = v[E]), F || (l.allowPanToNext = !1)
                    }
                }
            });
            var Qe, Ze, Ge, Ue, Ke, Je, ti, ei = function(e, i, n, s) {
                    ...
                    if (!c || !r || void 0 === r.x) return Et("initialZoom" + (n ? "Out" : "In")), y = e.initialZoomLevel, _t(ft, e.initialPosition), Ft(), t.style.opacity = n ? 0 : 1, It(1), void(c ? setTimeout(function() {
                        u()
                    }, c) : u());
                    var p = function() {
                        var i = h,
                            s = !a.currItem.src || a.currItem.loadError || l.showHideOpacity;
                        e.miniImg && (e.miniImg.style.webkitBackfaceVisibility = "hidden"), n || (y = r.w / e.w, ft.x = r.x, ft.y = r.y - z, a[s ? "template" : "bg"].style.opacity = .001, Ft()), te("initialZoom"), n && !i && o.removeClass(t, "pswp--animated-in"), s && (n ? o[(i ? "remove" : "add") + "Class"](t, "pswp--animate_opacity") : setTimeout(function() {
                            ...
                            if (Et("initialZoom" + (n ? "Out" : "In")), n) {
                                var a = r.w / e.w,
                                    ...
                                    d = lt,
                                    p = function(e) {
                                        1 === e ? (y = a, ft.x = r.x, ft.y = r.y - V) : (y = (a - h) * e + h, ft.x = (r.x - l.x) * e + l.x, ft.y = (r.y - V - l.y) * e + l.y), Ft(), s ? t.style.opacity = 1 - e : It(d - e * d)
                                    };
                                i ? ie("initialZoom", 0, 1, c, o.easing.cubic.out, p, u) : (p(1), Qe = setTimeout(u, c + 20))
                            } else y = e.initialZoomLevel, _t(ft, e.initialPosition), Ft(), It(1), s ? t.style.opacity = 1 : It(1), Qe = setTimeout(u, c + 20)
                        }, n ? 25 : 90)
                    };
                    p()
                },
            ...
            var vi, yi, bi, wi, xi, Ci, ki, Si, Ti, Pi, Ai, Ei, Mi = {
                    history: !0,
                    galleryUID: 1
                },
                Ii = function() {
                ...
                publicMethods: {
                    initHistory: function() {
                        if (o.extend(l, Mi, !0), l.history) {
                            Ai = window.location, Pi = !1, Ti = !1, Si = !1, ki = Ii(), Ei = "pushState" in history, ki.indexOf("gid=") > -1 && (ki = ki.split("&gid=")[0], ki = ki.split("?gid=")[0]), At("afterChange", a.updateURL), At("unbindEvents", function() {
                                o.unbind(window, "hashchange", a.onHashChange)
                            });
                            var t = function() {
                                Ci = !0, Ti || (Pi ? history.back() : ki ? Ai.hash = ki : Ei ? history.pushState("", document.title, Ai.pathname + Ai.search) : Ai.hash = ""), Oi()
                            };
                            At("unbindEvents", function() {
                                h && t()
                            }), At("destroy", function() {
                    ...
                    onHashChange: function() {
                        return Ii() === ki ? (Ti = !0, void a.close()) : void(wi || (xi = !0, a.goTo(Fi().pid), xi = !1))
                    },
                    updateURL: function() {
                        Oi(), xi || (Si ? vi = setTimeout(Li, 800) : Li())
                    }
                }
            }), o.extend(a, ne)
        };
        ...
        "use strict";
        var t = function(t, e) {
            var i, n, o, a, s, r, l, c, u, h, d, p, f, m, g, v, y, b, w, x = this,
                C = !1,
                k = !0,
                S = !0,
                T = {
                ...
                P = function(t) {
                    if (v) return !0;
                    t = t || window.event, g.timeToIdle && g.mouseUsed && !u && z();
                ...
                W = function() {
                    g.preloaderEl && (H(!0), h("beforeChange", function() {
                    ...
                    var t, i, o, a = function(n) {
                        if (n)
                            for (var a = n.length, s = 0; a > s; s++) {
                                t = n[s], i = t.className;
                                for (var r = 0; r < $.length; r++) o = $[r], i.indexOf("pswp__" + o.name) > -1 && (g[o.option] ? (e.removeClass(t, "pswp__element--disabled"), o.onInit && o.onInit(t)) : e.addClass(t, "pswp__element--disabled"))
                            }
                    };
                    a(n.children);
            ...
            x.init = function() {
                e.extend(t.options, T, !0), g = t.options, n = e.getChildByClass(t.scrollWrap, "pswp__ui"), h = t.listen, j(), h("beforeChange", x.update), h("doubleTap", function(e) {
                    ...
                    S || O(), b && clearInterval(b), e.unbind(document, "mouseout", _), e.unbind(document, "mousemove", z), e.unbind(n, "pswpTap click", P), e.unbind(t.scrollWrap, "pswpTap", x.onGlobalTap), e.unbind(t.scrollWrap, "mouseover", x.onMouseOver), i && (e.unbind(document, i.eventK, x.updateFullscreen), i.isFullscreen() && (g.hideAnimationDuration = 0, i.exit()), i = null)
                }), h("destroy", function() {
                ...
                }), h("parseVerticalMargin", B), q(), g.shareEl && r && l && (S = !0), M(), N(), V(), W()
            }, x.setIdle = function(t) {
                u = t, E(n, "ui--idle", t)
            }, x.update = function() {
                k && t.currItem ? (x.updateIndexIndicator(), g.captionEl && (g.addCaptionHTMLFn(t.currItem, o), E(o, "caption--empty", !t.currItem.title)), C = !0) : C = !1, S || O(), M()
                ...
                if (!v)
                    ...
                    } else if (g.tapToToggleControls && (k ? x.hideControls() : x.showControls()), g.tapToClose && (e.hasClass(n, "pswp__img") || D(n))) return void t.close()
...
var initPhotoSwipeFromDOM = function(t) {
    for (var e = function(t) {
            for (var e, i, n, o, a = t.childNodes, s = a.length, r = [], l = 0; s > l; l++) e = a[l], 1 === e.nodeType && (i = e.children[0], n = i.getAttribute("data-size").split("x"), o = {
            ...
            if (n) {
                for (var o, s = n.parentNode, r = n.parentNode.childNodes, l = r.length, c = 0, u = 0; l > u; u++)
                    if (1 === r[u].nodeType) {
                        if (r[u] === n) {
                            o = c;
                            break
...
initPhotoSwipeFromDOM(".mdb-lightbox"),
    function(t) {
        t.fn.sticky = function(e) {
            function i() {
                return "number" == typeof a.zIndex ? !0 : !1
            }

            function n() {
                return 0 < t(a.stopper).length || "number" == typeof a.stopper ? !0 : !1
            }
            var o = {
                    topSpacing: 0,
                    zIndex: "",
            ...
            return this.each(function() {
                function e() {
                    var e = p.scrollTop();
                    if (r && "string" == typeof d) var o = t(d).offset().top,
                        a = o - n - l;
                    else if (r && "number" == typeof d) var a = d;
                    if (e > u) {
                        if (i.after(h).css({
                                position: "fixed",
                                top: l
                ...
                var i = t(this),
                    ...
                    c = a.zIndex,
                    u = i.offset().top - l,
                    h = t("<div></div>").width(o).height(n).addClass("sticky-placeholder"),
                    d = a.stopper,
                    p = t(window);
                p.bind("scroll", e)
            })
